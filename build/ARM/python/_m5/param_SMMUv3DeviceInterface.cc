...
namespace gem5
{
namespace gem5_SMMUv3DeviceInterface_create
{
...
template<>
struct [[deprecated(
        "Warning: SMMUv3DeviceInterface is not constructible from SMMUv3DeviceInterfaceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SMMUv3DeviceInterface has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SMMUv3DeviceInterface,
                             const SMMUv3DeviceInterfaceParams &>> warning_instance;
} // namespace gem5_SMMUv3DeviceInterface_create
} // namespace gem5

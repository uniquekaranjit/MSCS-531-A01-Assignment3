...
namespace gem5
{
namespace gem5_MinorOpClass_create
{
...
template<>
struct [[deprecated(
        "Warning: MinorOpClass is not constructible from MinorOpClassParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MinorOpClass has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MinorOpClass,
                             const MinorOpClassParams &>> warning_instance;
} // namespace gem5_MinorOpClass_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_GenericArmPciHost_create
{
...
template<>
struct [[deprecated(
        "Warning: GenericArmPciHost is not constructible from GenericArmPciHostParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GenericArmPciHost has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GenericArmPciHost,
                             const GenericArmPciHostParams &>> warning_instance;
} // namespace gem5_GenericArmPciHost_create
} // namespace gem5

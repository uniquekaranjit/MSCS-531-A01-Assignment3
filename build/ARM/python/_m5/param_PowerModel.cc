...
namespace gem5
{
namespace gem5_PowerModel_create
{
...
template<>
struct [[deprecated(
        "Warning: PowerModel is not constructible from PowerModelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PowerModel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PowerModel,
                             const PowerModelParams &>> warning_instance;
} // namespace gem5_PowerModel_create
} // namespace gem5

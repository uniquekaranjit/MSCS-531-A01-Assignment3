...
namespace gem5
{
namespace gem5_SerialNullDevice_create
{
...
template<>
struct [[deprecated(
        "Warning: SerialNullDevice is not constructible from SerialNullDeviceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SerialNullDevice has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SerialNullDevice,
                             const SerialNullDeviceParams &>> warning_instance;
} // namespace gem5_SerialNullDevice_create
} // namespace gem5

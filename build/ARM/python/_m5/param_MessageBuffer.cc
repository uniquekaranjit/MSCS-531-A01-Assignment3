...
namespace gem5
{
namespace gem5_ruby_MessageBuffer_create
{
...
template<>
struct [[deprecated(
        "Warning: MessageBuffer is not constructible from MessageBufferParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MessageBuffer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::MessageBuffer,
                             const MessageBufferParams &>> warning_instance;
} // namespace gem5_ruby_MessageBuffer_create
} // namespace gem5

...
template<>
struct [[deprecated(
        "Warning: IsaFake is not constructible from IsaFakeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is IsaFake has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::IsaFake,
                             const IsaFakeParams &>> warning_instance;
} // namespace gem5_IsaFake_create
} // namespace gem5

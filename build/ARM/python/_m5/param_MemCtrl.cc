...
namespace gem5
{
namespace gem5_memory_MemCtrl_create
{
...
template<>
struct [[deprecated(
        "Warning: MemCtrl is not constructible from MemCtrlParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MemCtrl has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::MemCtrl,
                             const MemCtrlParams &>> warning_instance;
} // namespace gem5_memory_MemCtrl_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_ruby_RubySystem_create
{
...
template<>
struct [[deprecated(
        "Warning: RubySystem is not constructible from RubySystemParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RubySystem has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::RubySystem,
                             const RubySystemParams &>> warning_instance;
} // namespace gem5_ruby_RubySystem_create
} // namespace gem5

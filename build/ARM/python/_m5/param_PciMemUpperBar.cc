...
class DummyPciMemUpperBarShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const PciMemUpperBarParams &>>>
{
  public:
...
{
    return DummyPciMemUpperBarShunt<gem5::PciMemUpperBar>::create(*this);
}
...
namespace gem5
{
namespace gem5_PciMemUpperBar_create
{
...
template<>
struct [[deprecated(
        "Warning: PciMemUpperBar is not constructible from PciMemUpperBarParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PciMemUpperBar has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PciMemUpperBar,
                             const PciMemUpperBarParams &>> warning_instance;
} // namespace gem5_PciMemUpperBar_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_ps2_PS2Keyboard_create
{
...
template<>
struct [[deprecated(
        "Warning: PS2Keyboard is not constructible from PS2KeyboardParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PS2Keyboard has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ps2::PS2Keyboard,
                             const PS2KeyboardParams &>> warning_instance;
} // namespace gem5_ps2_PS2Keyboard_create
} // namespace gem5

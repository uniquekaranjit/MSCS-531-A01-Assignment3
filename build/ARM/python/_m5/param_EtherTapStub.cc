...
namespace gem5
{
namespace gem5_EtherTapStub_create
{
...
template<>
struct [[deprecated(
        "Warning: EtherTapStub is not constructible from EtherTapStubParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is EtherTapStub has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::EtherTapStub,
                             const EtherTapStubParams &>> warning_instance;
} // namespace gem5_EtherTapStub_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_memory_qos_MemSinkCtrl_create
{
...
template<>
struct [[deprecated(
        "Warning: QoSMemSinkCtrl is not constructible from QoSMemSinkCtrlParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is QoSMemSinkCtrl has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::qos::MemSinkCtrl,
                             const QoSMemSinkCtrlParams &>> warning_instance;
} // namespace gem5_memory_qos_MemSinkCtrl_create
} // namespace gem5

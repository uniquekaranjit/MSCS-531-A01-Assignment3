...
namespace gem5
{
namespace gem5_branch_prediction_TAGE_create
{
...
template<>
struct [[deprecated(
        "Warning: TAGE is not constructible from TAGEParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TAGE has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::TAGE,
                             const TAGEParams &>> warning_instance;
} // namespace gem5_branch_prediction_TAGE_create
} // namespace gem5

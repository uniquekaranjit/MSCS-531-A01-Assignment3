...
namespace gem5
{
namespace gem5_prefetch_DCPT_create
{
...
template<>
struct [[deprecated(
        "Warning: DCPTPrefetcher is not constructible from DCPTPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is DCPTPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::DCPT,
                             const DCPTPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_DCPT_create
} // namespace gem5

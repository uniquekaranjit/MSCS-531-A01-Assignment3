...
namespace gem5
{
namespace gem5_trace_IntelTrace_create
{
...
template<>
struct [[deprecated(
        "Warning: IntelTrace is not constructible from IntelTraceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is IntelTrace has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::trace::IntelTrace,
                             const IntelTraceParams &>> warning_instance;
} // namespace gem5_trace_IntelTrace_create
} // namespace gem5

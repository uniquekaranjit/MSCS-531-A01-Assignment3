...
py::module_ m = m_internal.def_submodule("param_PciVirtIO");
    py::class_<PciVirtIOParams, PciEndpointParams, std::unique_ptr<PciVirtIOParams, py::nodelete>>(m, "PciVirtIOParams")
        .def(py::init<>())
        .def("create", &PciVirtIOParams::create)
        .def_readwrite("vio", &PciVirtIOParams::vio)
        ;

    py::class_<gem5::PciVirtIO, gem5::PciEndpoint, std::unique_ptr<gem5::PciVirtIO, py::nodelete>>(m, "gem5_COLONS_PciVirtIO")
        ;

}

static EmbeddedPyBind embed_obj("PciVirtIO", module_init, "PciEndpoint");
...
namespace gem5
{
namespace gem5_PciVirtIO_create
{
...
template<>
struct [[deprecated(
        "Warning: PciVirtIO is not constructible from PciVirtIOParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PciVirtIO has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PciVirtIO,
                             const PciVirtIOParams &>> warning_instance;
} // namespace gem5_PciVirtIO_create
} // namespace gem5

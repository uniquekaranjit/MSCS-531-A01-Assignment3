...
namespace gem5
{
namespace gem5_GenericTimerFrame_create
{
...
template<>
struct [[deprecated(
        "Warning: GenericTimerFrame is not constructible from GenericTimerFrameParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GenericTimerFrame has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GenericTimerFrame,
                             const GenericTimerFrameParams &>> warning_instance;
} // namespace gem5_GenericTimerFrame_create
} // namespace gem5

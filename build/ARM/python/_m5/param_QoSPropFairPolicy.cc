...
namespace gem5
{
namespace gem5_memory_qos_PropFairPolicy_create
{
...
template<>
struct [[deprecated(
        "Warning: QoSPropFairPolicy is not constructible from QoSPropFairPolicyParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is QoSPropFairPolicy has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::qos::PropFairPolicy,
                             const QoSPropFairPolicyParams &>> warning_instance;
} // namespace gem5_memory_qos_PropFairPolicy_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_replacement_policy_FIFO_create
{
...
template<>
struct [[deprecated(
        "Warning: FIFORP is not constructible from FIFORPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is FIFORP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::FIFO,
                             const FIFORPParams &>> warning_instance;
} // namespace gem5_replacement_policy_FIFO_create
} // namespace gem5

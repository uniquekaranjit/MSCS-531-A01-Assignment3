...
namespace gem5
{
namespace gem5_TimingExprIf_create
{
...
template<>
struct [[deprecated(
        "Warning: TimingExprIf is not constructible from TimingExprIfParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TimingExprIf has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingExprIf,
                             const TimingExprIfParams &>> warning_instance;
} // namespace gem5_TimingExprIf_create
} // namespace gem5

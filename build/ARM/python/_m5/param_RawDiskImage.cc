...
namespace gem5
{
namespace gem5_RawDiskImage_create
{
...
template<>
struct [[deprecated(
        "Warning: RawDiskImage is not constructible from RawDiskImageParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RawDiskImage has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RawDiskImage,
                             const RawDiskImageParams &>> warning_instance;
} // namespace gem5_RawDiskImage_create
} // namespace gem5

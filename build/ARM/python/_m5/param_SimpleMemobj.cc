...
namespace gem5
{
namespace gem5_SimpleMemobj_create
{
...
template<>
struct [[deprecated(
        "Warning: SimpleMemobj is not constructible from SimpleMemobjParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimpleMemobj has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SimpleMemobj,
                             const SimpleMemobjParams &>> warning_instance;
} // namespace gem5_SimpleMemobj_create
} // namespace gem5

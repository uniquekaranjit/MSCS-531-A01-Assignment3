...
namespace gem5
{
namespace gem5_ThermalNode_create
{
...
template<>
struct [[deprecated(
        "Warning: ThermalNode is not constructible from ThermalNodeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ThermalNode has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ThermalNode,
                             const ThermalNodeParams &>> warning_instance;
} // namespace gem5_ThermalNode_create
} // namespace gem5

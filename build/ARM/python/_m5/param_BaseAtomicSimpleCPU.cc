...
namespace gem5
{
namespace gem5_AtomicSimpleCPU_create
{
...
template<>
struct [[deprecated(
        "Warning: BaseAtomicSimpleCPU is not constructible from BaseAtomicSimpleCPUParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BaseAtomicSimpleCPU has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::AtomicSimpleCPU,
                             const BaseAtomicSimpleCPUParams &>> warning_instance;
} // namespace gem5_AtomicSimpleCPU_create
} // namespace gem5

...
class DummyNoncoherentCacheShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const NoncoherentCacheParams &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::NoncoherentCache *
DummyNoncoherentCacheShunt<gem5::NoncoherentCache>::Params::create() const
{
    return DummyNoncoherentCacheShunt<gem5::NoncoherentCache>::create(*this);
}
...
namespace gem5
{
namespace gem5_NoncoherentCache_create
{
...
template<>
struct [[deprecated(
        "Warning: NoncoherentCache is not constructible from NoncoherentCacheParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is NoncoherentCache has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::NoncoherentCache,
                             const NoncoherentCacheParams &>> warning_instance;
} // namespace gem5_NoncoherentCache_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_trace_TarmacParser_create
{
...
template<>
struct [[deprecated(
        "Warning: TarmacParser is not constructible from TarmacParserParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TarmacParser has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::trace::TarmacParser,
                             const TarmacParserParams &>> warning_instance;
} // namespace gem5_trace_TarmacParser_create
} // namespace gem5

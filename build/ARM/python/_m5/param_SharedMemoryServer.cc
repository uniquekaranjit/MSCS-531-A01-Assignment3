...
namespace gem5
{
namespace gem5_memory_SharedMemoryServer_create
{
...
template<>
struct [[deprecated(
        "Warning: SharedMemoryServer is not constructible from SharedMemoryServerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SharedMemoryServer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::SharedMemoryServer,
                             const SharedMemoryServerParams &>> warning_instance;
} // namespace gem5_memory_SharedMemoryServer_create
} // namespace gem5

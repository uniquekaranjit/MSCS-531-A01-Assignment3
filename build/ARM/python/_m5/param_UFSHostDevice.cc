...
namespace gem5
{
namespace gem5_UFSHostDevice_create
{
...
template<>
struct [[deprecated(
        "Warning: UFSHostDevice is not constructible from UFSHostDeviceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is UFSHostDevice has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::UFSHostDevice,
                             const UFSHostDeviceParams &>> warning_instance;
} // namespace gem5_UFSHostDevice_create
} // namespace gem5

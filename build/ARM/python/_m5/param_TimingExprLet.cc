...
namespace gem5
{
namespace gem5_TimingExprLet_create
{
...
template<>
struct [[deprecated(
        "Warning: TimingExprLet is not constructible from TimingExprLetParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TimingExprLet has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingExprLet,
                             const TimingExprLetParams &>> warning_instance;
} // namespace gem5_TimingExprLet_create
} // namespace gem5

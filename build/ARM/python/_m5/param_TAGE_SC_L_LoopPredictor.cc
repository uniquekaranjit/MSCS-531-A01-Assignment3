...
namespace gem5
{
namespace gem5_branch_prediction_TAGE_SC_L_LoopPredictor_create
{
...
template<>
struct [[deprecated(
        "Warning: TAGE_SC_L_LoopPredictor is not constructible from TAGE_SC_L_LoopPredictorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TAGE_SC_L_LoopPredictor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::TAGE_SC_L_LoopPredictor,
                             const TAGE_SC_L_LoopPredictorParams &>> warning_instance;
} // namespace gem5_branch_prediction_TAGE_SC_L_LoopPredictor_create
} // namespace gem5

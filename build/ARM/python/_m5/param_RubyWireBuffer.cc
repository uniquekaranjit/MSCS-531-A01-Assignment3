...
namespace gem5
{
namespace gem5_ruby_WireBuffer_create
{
...
template<>
struct [[deprecated(
        "Warning: RubyWireBuffer is not constructible from RubyWireBufferParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RubyWireBuffer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::WireBuffer,
                             const RubyWireBufferParams &>> warning_instance;
} // namespace gem5_ruby_WireBuffer_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_replacement_policy_BRRIP_create
{
...
template<>
struct [[deprecated(
        "Warning: BRRIPRP is not constructible from BRRIPRPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BRRIPRP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::BRRIP,
                             const BRRIPRPParams &>> warning_instance;
} // namespace gem5_replacement_policy_BRRIP_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_TimingExprRef_create
{
...
template<>
struct [[deprecated(
        "Warning: TimingExprRef is not constructible from TimingExprRefParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TimingExprRef has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingExprRef,
                             const TimingExprRefParams &>> warning_instance;
} // namespace gem5_TimingExprRef_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_prefetch_PIF_create
{
...
template<>
struct [[deprecated(
        "Warning: PIFPrefetcher is not constructible from PIFPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PIFPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::PIF,
                             const PIFPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_PIF_create
} // namespace gem5

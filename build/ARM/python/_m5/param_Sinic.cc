...
namespace gem5
{
namespace gem5_sinic_Device_create
{
...
template<>
struct [[deprecated(
        "Warning: Sinic is not constructible from SinicParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Sinic has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::sinic::Device,
                             const SinicParams &>> warning_instance;
} // namespace gem5_sinic_Device_create
} // namespace gem5

...
py::module_ m = m_internal.def_submodule("param_BaseCPU");
    py::class_<BaseCPUParams, ClockedObjectParams, std::unique_ptr<BaseCPUParams, py::nodelete>>(m, "BaseCPUParams")
        ...
        .def_readwrite("port_model_reset_connection_count", &BaseCPUParams::port_model_reset_connection_count)
        .def_readwrite("port_cpu_idle_pins_connection_count", &BaseCPUParams::port_cpu_idle_pins_connection_count)

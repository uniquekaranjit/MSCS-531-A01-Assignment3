...
class DummyFPCShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const FPCParams &>>>
{
  public:
...
{
    return DummyFPCShunt<gem5::compression::FPC>::create(*this);
}
...
namespace gem5
{
namespace gem5_compression_FPC_create
{
...
template<>
struct [[deprecated(
        "Warning: FPC is not constructible from FPCParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is FPC has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::FPC,
                             const FPCParams &>> warning_instance;
} // namespace gem5_compression_FPC_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_Uart8250_create
{
...
template<>
struct [[deprecated(
        "Warning: Uart8250 is not constructible from Uart8250Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Uart8250 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::Uart8250,
                             const Uart8250Params &>> warning_instance;
} // namespace gem5_Uart8250_create
} // namespace gem5

...
py::module_ m = m_internal.def_submodule("param_BOPPrefetcher");
    py::class_<BOPPrefetcherParams, QueuedPrefetcherParams, std::unique_ptr<BOPPrefetcherParams, py::nodelete>>(m, "BOPPrefetcherParams")
        ...
        .def_readwrite("degree", &BOPPrefetcherParams::degree)
...
namespace gem5
{
namespace gem5_prefetch_BOP_create
{
...
template<>
struct [[deprecated(
        "Warning: BOPPrefetcher is not constructible from BOPPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BOPPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::BOP,
                             const BOPPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_BOP_create
} // namespace gem5

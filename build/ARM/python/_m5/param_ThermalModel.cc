...
namespace gem5
{
namespace gem5_ThermalModel_create
{
...
template<>
struct [[deprecated(
        "Warning: ThermalModel is not constructible from ThermalModelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ThermalModel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ThermalModel,
                             const ThermalModelParams &>> warning_instance;
} // namespace gem5_ThermalModel_create
} // namespace gem5

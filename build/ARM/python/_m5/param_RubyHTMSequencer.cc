...
namespace gem5
{
namespace gem5_ruby_HTMSequencer_create
{
...
template<>
struct [[deprecated(
        "Warning: RubyHTMSequencer is not constructible from RubyHTMSequencerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RubyHTMSequencer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::HTMSequencer,
                             const RubyHTMSequencerParams &>> warning_instance;
} // namespace gem5_ruby_HTMSequencer_create
} // namespace gem5

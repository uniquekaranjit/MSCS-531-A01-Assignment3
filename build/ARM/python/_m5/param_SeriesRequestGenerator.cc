...
namespace gem5
{
namespace gem5_SeriesRequestGenerator_create
{
...
template<>
struct [[deprecated(
        "Warning: SeriesRequestGenerator is not constructible from SeriesRequestGeneratorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SeriesRequestGenerator has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SeriesRequestGenerator,
                             const SeriesRequestGeneratorParams &>> warning_instance;
} // namespace gem5_SeriesRequestGenerator_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_VirtIODummyDevice_create
{
...
template<>
struct [[deprecated(
        "Warning: VirtIODummyDevice is not constructible from VirtIODummyDeviceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is VirtIODummyDevice has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::VirtIODummyDevice,
                             const VirtIODummyDeviceParams &>> warning_instance;
} // namespace gem5_VirtIODummyDevice_create
} // namespace gem5

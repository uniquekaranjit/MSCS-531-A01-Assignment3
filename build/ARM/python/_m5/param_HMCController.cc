...
namespace gem5
{
namespace gem5_HMCController_create
{
...
template<>
struct [[deprecated(
        "Warning: HMCController is not constructible from HMCControllerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is HMCController has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::HMCController,
                             const HMCControllerParams &>> warning_instance;
} // namespace gem5_HMCController_create
} // namespace gem5

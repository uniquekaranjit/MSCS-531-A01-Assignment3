...
namespace gem5
{
namespace gem5_trace_ExeTracer_create
{
...
template<>
struct [[deprecated(
        "Warning: ExeTracer is not constructible from ExeTracerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ExeTracer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::trace::ExeTracer,
                             const ExeTracerParams &>> warning_instance;
} // namespace gem5_trace_ExeTracer_create
} // namespace gem5

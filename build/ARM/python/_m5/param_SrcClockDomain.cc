...
namespace gem5
{
namespace gem5_SrcClockDomain_create
{
...
template<>
struct [[deprecated(
        "Warning: SrcClockDomain is not constructible from SrcClockDomainParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SrcClockDomain has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SrcClockDomain,
                             const SrcClockDomainParams &>> warning_instance;
} // namespace gem5_SrcClockDomain_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_branch_prediction_TAGE_SC_L_8KB_StatisticalCorrector_create
{
...
template<>
struct [[deprecated(
        "Warning: TAGE_SC_L_8KB_StatisticalCorrector is not constructible from TAGE_SC_L_8KB_StatisticalCorrectorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TAGE_SC_L_8KB_StatisticalCorrector has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::TAGE_SC_L_8KB_StatisticalCorrector,
                             const TAGE_SC_L_8KB_StatisticalCorrectorParams &>> warning_instance;
} // namespace gem5_branch_prediction_TAGE_SC_L_8KB_StatisticalCorrector_create
} // namespace gem5

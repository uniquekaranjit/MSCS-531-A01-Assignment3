...
namespace gem5
{
namespace gem5_MemTraceProbe_create
{
...
template<>
struct [[deprecated(
        "Warning: MemTraceProbe is not constructible from MemTraceProbeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MemTraceProbe has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MemTraceProbe,
                             const MemTraceProbeParams &>> warning_instance;
} // namespace gem5_MemTraceProbe_create
} // namespace gem5

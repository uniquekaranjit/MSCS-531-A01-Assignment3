...
namespace gem5
{
namespace gem5_compression_CPack_create
{
...
template<>
struct [[deprecated(
        "Warning: CPack is not constructible from CPackParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CPack has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::CPack,
                             const CPackParams &>> warning_instance;
} // namespace gem5_compression_CPack_create
} // namespace gem5

...
template<>
struct [[deprecated(
        "Warning: GUPSGen is not constructible from GUPSGenParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GUPSGen has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GUPSGen,
                             const GUPSGenParams &>> warning_instance;
} // namespace gem5_GUPSGen_create
} // namespace gem5

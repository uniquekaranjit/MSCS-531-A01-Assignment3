...
namespace gem5
{
namespace gem5_bloom_filter_Block_create
{
...
template<>
struct [[deprecated(
        "Warning: BloomFilterBlock is not constructible from BloomFilterBlockParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BloomFilterBlock has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::bloom_filter::Block,
                             const BloomFilterBlockParams &>> warning_instance;
} // namespace gem5_bloom_filter_Block_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_branch_prediction_MultiperspectivePerceptronTAGE8KB_create
{
...
template<>
struct [[deprecated(
        "Warning: MultiperspectivePerceptronTAGE8KB is not constructible from MultiperspectivePerceptronTAGE8KBParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MultiperspectivePerceptronTAGE8KB has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::MultiperspectivePerceptronTAGE8KB,
                             const MultiperspectivePerceptronTAGE8KBParams &>> warning_instance;
} // namespace gem5_branch_prediction_MultiperspectivePerceptronTAGE8KB_create
} // namespace gem5

...
template<>
struct [[deprecated(
        "Warning: MemTest is not constructible from MemTestParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MemTest has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MemTest,
                             const MemTestParams &>> warning_instance;
} // namespace gem5_MemTest_create
} // namespace gem5

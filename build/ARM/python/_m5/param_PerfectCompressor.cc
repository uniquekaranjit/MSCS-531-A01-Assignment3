...
namespace gem5
{
namespace gem5_compression_Perfect_create
{
...
template<>
struct [[deprecated(
        "Warning: PerfectCompressor is not constructible from PerfectCompressorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PerfectCompressor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Perfect,
                             const PerfectCompressorParams &>> warning_instance;
} // namespace gem5_compression_Perfect_create
} // namespace gem5

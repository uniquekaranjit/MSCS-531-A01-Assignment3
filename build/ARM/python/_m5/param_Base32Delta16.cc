...
namespace gem5
{
namespace gem5_compression_Base32Delta16_create
{
...
template<>
struct [[deprecated(
        "Warning: Base32Delta16 is not constructible from Base32Delta16Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Base32Delta16 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Base32Delta16,
                             const Base32Delta16Params &>> warning_instance;
} // namespace gem5_compression_Base32Delta16_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_DistEtherLink_create
{
...
template<>
struct [[deprecated(
        "Warning: DistEtherLink is not constructible from DistEtherLinkParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is DistEtherLink has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::DistEtherLink,
                             const DistEtherLinkParams &>> warning_instance;
} // namespace gem5_DistEtherLink_create
} // namespace gem5

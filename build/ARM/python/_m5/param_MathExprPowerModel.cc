...
class DummyMathExprPowerModelShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const MathExprPowerModelParams &>>>
{
  public:
...
{
    return DummyMathExprPowerModelShunt<gem5::MathExprPowerModel>::create(*this);
}
...
namespace gem5
{
namespace gem5_MathExprPowerModel_create
{
...
template<>
struct [[deprecated(
        "Warning: MathExprPowerModel is not constructible from MathExprPowerModelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MathExprPowerModel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MathExprPowerModel,
                             const MathExprPowerModelParams &>> warning_instance;
} // namespace gem5_MathExprPowerModel_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_MemChecker_create
{
...
template<>
struct [[deprecated(
        "Warning: MemChecker is not constructible from MemCheckerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MemChecker has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MemChecker,
                             const MemCheckerParams &>> warning_instance;
} // namespace gem5_MemChecker_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_ruby_garnet_GarnetNetwork_create
{
...
template<>
struct [[deprecated(
        "Warning: GarnetNetwork is not constructible from GarnetNetworkParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GarnetNetwork has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::garnet::GarnetNetwork,
                             const GarnetNetworkParams &>> warning_instance;
} // namespace gem5_ruby_garnet_GarnetNetwork_create
} // namespace gem5

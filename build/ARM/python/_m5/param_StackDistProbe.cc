...
namespace gem5
{
namespace gem5_StackDistProbe_create
{
...
template<>
struct [[deprecated(
        "Warning: StackDistProbe is not constructible from StackDistProbeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is StackDistProbe has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::StackDistProbe,
                             const StackDistProbeParams &>> warning_instance;
} // namespace gem5_StackDistProbe_create
} // namespace gem5

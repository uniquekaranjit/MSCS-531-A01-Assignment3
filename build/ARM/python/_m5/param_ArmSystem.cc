...
namespace gem5
{
namespace gem5_ArmSystem_create
{
...
template<>
struct [[deprecated(
        "Warning: ArmSystem is not constructible from ArmSystemParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ArmSystem has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ArmSystem,
                             const ArmSystemParams &>> warning_instance;
} // namespace gem5_ArmSystem_create
} // namespace gem5

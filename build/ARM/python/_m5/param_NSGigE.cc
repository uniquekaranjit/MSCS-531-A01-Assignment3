...
template<>
struct [[deprecated(
        "Warning: NSGigE is not constructible from NSGigEParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is NSGigE has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::NSGigE,
                             const NSGigEParams &>> warning_instance;
} // namespace gem5_NSGigE_create
} // namespace gem5

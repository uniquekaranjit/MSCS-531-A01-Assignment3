...
namespace gem5
{
namespace gem5_replacement_policy_TreePLRU_create
{
...
template<>
struct [[deprecated(
        "Warning: TreePLRURP is not constructible from TreePLRURPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TreePLRURP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::TreePLRU,
                             const TreePLRURPParams &>> warning_instance;
} // namespace gem5_replacement_policy_TreePLRU_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_bloom_filter_Perfect_create
{
...
template<>
struct [[deprecated(
        "Warning: BloomFilterPerfect is not constructible from BloomFilterPerfectParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BloomFilterPerfect has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::bloom_filter::Perfect,
                             const BloomFilterPerfectParams &>> warning_instance;
} // namespace gem5_bloom_filter_Perfect_create
} // namespace gem5

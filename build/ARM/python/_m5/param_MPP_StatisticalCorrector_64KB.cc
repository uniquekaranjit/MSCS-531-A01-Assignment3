...
class DummyMPP_StatisticalCorrector_64KBShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const MPP_StatisticalCorrector_64KBParams &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::branch_prediction::MPP_StatisticalCorrector_64KB *
DummyMPP_StatisticalCorrector_64KBShunt<gem5::branch_prediction::MPP_StatisticalCorrector_64KB>::Params::create() const
{
    return DummyMPP_StatisticalCorrector_64KBShunt<gem5::branch_prediction::MPP_StatisticalCorrector_64KB>::create(*this);
}
...
namespace gem5
{
namespace gem5_branch_prediction_MPP_StatisticalCorrector_64KB_create
{
...
template<>
struct [[deprecated(
        "Warning: MPP_StatisticalCorrector_64KB is not constructible from MPP_StatisticalCorrector_64KBParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MPP_StatisticalCorrector_64KB has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::MPP_StatisticalCorrector_64KB,
                             const MPP_StatisticalCorrector_64KBParams &>> warning_instance;
} // namespace gem5_branch_prediction_MPP_StatisticalCorrector_64KB_create
} // namespace gem5

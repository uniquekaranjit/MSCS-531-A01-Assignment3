...
namespace gem5
{
namespace gem5_SerialLink_create
{
...
template<>
struct [[deprecated(
        "Warning: SerialLink is not constructible from SerialLinkParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SerialLink has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SerialLink,
                             const SerialLinkParams &>> warning_instance;
} // namespace gem5_SerialLink_create
} // namespace gem5

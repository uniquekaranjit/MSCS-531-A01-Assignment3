...
namespace gem5
{
namespace gem5_prefetch_AccessMapPatternMatching_create
{
...
template<>
struct [[deprecated(
        "Warning: AccessMapPatternMatching is not constructible from AccessMapPatternMatchingParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is AccessMapPatternMatching has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::AccessMapPatternMatching,
                             const AccessMapPatternMatchingParams &>> warning_instance;
} // namespace gem5_prefetch_AccessMapPatternMatching_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_trace_InstPBTrace_create
{
...
template<>
struct [[deprecated(
        "Warning: InstPBTrace is not constructible from InstPBTraceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is InstPBTrace has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::trace::InstPBTrace,
                             const InstPBTraceParams &>> warning_instance;
} // namespace gem5_trace_InstPBTrace_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_ruby_DMASequencer_create
{
...
template<>
struct [[deprecated(
        "Warning: DMASequencer is not constructible from DMASequencerParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is DMASequencer has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::DMASequencer,
                             const DMASequencerParams &>> warning_instance;
} // namespace gem5_ruby_DMASequencer_create
} // namespace gem5

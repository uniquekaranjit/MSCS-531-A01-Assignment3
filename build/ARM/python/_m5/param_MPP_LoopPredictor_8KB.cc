...
namespace gem5
{
namespace gem5_branch_prediction_MPP_LoopPredictor_8KB_create
{
...
template<>
struct [[deprecated(
        "Warning: MPP_LoopPredictor_8KB is not constructible from MPP_LoopPredictor_8KBParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MPP_LoopPredictor_8KB has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::MPP_LoopPredictor_8KB,
                             const MPP_LoopPredictor_8KBParams &>> warning_instance;
} // namespace gem5_branch_prediction_MPP_LoopPredictor_8KB_create
} // namespace gem5

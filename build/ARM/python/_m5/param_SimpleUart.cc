...
namespace gem5
{
namespace gem5_SimpleUart_create
{
...
template<>
struct [[deprecated(
        "Warning: SimpleUart is not constructible from SimpleUartParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimpleUart has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SimpleUart,
                             const SimpleUartParams &>> warning_instance;
} // namespace gem5_SimpleUart_create
} // namespace gem5

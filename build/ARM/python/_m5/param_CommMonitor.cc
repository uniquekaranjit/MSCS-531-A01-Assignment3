...
namespace gem5
{
namespace gem5_CommMonitor_create
{
...
template<>
struct [[deprecated(
        "Warning: CommMonitor is not constructible from CommMonitorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CommMonitor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::CommMonitor,
                             const CommMonitorParams &>> warning_instance;
} // namespace gem5_CommMonitor_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_ThermalCapacitor_create
{
...
template<>
struct [[deprecated(
        "Warning: ThermalCapacitor is not constructible from ThermalCapacitorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ThermalCapacitor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ThermalCapacitor,
                             const ThermalCapacitorParams &>> warning_instance;
} // namespace gem5_ThermalCapacitor_create
} // namespace gem5

...
class DummySimpleTraceShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const SimpleTraceParams &>>>
{
  public:
...
{
    return DummySimpleTraceShunt<gem5::o3::SimpleTrace>::create(*this);
}
...
namespace gem5
{
namespace gem5_o3_SimpleTrace_create
{
...
template<>
struct [[deprecated(
        "Warning: SimpleTrace is not constructible from SimpleTraceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimpleTrace has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::o3::SimpleTrace,
                             const SimpleTraceParams &>> warning_instance;
} // namespace gem5_o3_SimpleTrace_create
} // namespace gem5

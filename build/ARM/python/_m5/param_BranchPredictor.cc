...
py::module_ m = m_internal.def_submodule("param_BranchPredictor");
    py::class_<BranchPredictorParams, SimObjectParams, std::unique_ptr<BranchPredictorParams, py::nodelete>>(m, "BranchPredictorParams")
        .def_readwrite("btb", &BranchPredictorParams::btb)
        ...
        .def_readwrite("ras", &BranchPredictorParams::ras)
        .def_readwrite("requiresBTBHit", &BranchPredictorParams::requiresBTBHit)
        .def_readwrite("speculativeHistUpdate", &BranchPredictorParams::speculativeHistUpdate)
        .def_readwrite("takenOnlyHistory", &BranchPredictorParams::takenOnlyHistory)
        ;

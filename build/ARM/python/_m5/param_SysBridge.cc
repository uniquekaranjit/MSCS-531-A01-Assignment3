...
namespace gem5
{
namespace gem5_SysBridge_create
{
...
template<>
struct [[deprecated(
        "Warning: SysBridge is not constructible from SysBridgeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SysBridge has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SysBridge,
                             const SysBridgeParams &>> warning_instance;
} // namespace gem5_SysBridge_create
} // namespace gem5

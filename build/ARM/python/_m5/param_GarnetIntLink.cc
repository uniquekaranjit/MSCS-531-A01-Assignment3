...
namespace gem5
{
namespace gem5_ruby_garnet_GarnetIntLink_create
{
...
template<>
struct [[deprecated(
        "Warning: GarnetIntLink is not constructible from GarnetIntLinkParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GarnetIntLink has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::garnet::GarnetIntLink,
                             const GarnetIntLinkParams &>> warning_instance;
} // namespace gem5_ruby_garnet_GarnetIntLink_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_scmi_VirtualChannel_create
{
...
template<>
struct [[deprecated(
        "Warning: ScmiChannel is not constructible from ScmiChannelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ScmiChannel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::scmi::VirtualChannel,
                             const ScmiChannelParams &>> warning_instance;
} // namespace gem5_scmi_VirtualChannel_create
} // namespace gem5

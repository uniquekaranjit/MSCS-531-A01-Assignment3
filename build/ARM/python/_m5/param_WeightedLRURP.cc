...
namespace gem5
{
namespace gem5_replacement_policy_WeightedLRU_create
{
...
template<>
struct [[deprecated(
        "Warning: WeightedLRURP is not constructible from WeightedLRURPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is WeightedLRURP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::WeightedLRU,
                             const WeightedLRURPParams &>> warning_instance;
} // namespace gem5_replacement_policy_WeightedLRU_create
} // namespace gem5

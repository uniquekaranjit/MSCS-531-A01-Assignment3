...
namespace gem5
{
namespace gem5_TimingSimpleCPU_create
{
...
template<>
struct [[deprecated(
        "Warning: BaseTimingSimpleCPU is not constructible from BaseTimingSimpleCPUParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BaseTimingSimpleCPU has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingSimpleCPU,
                             const BaseTimingSimpleCPUParams &>> warning_instance;
} // namespace gem5_TimingSimpleCPU_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_bloom_filter_H3_create
{
...
template<>
struct [[deprecated(
        "Warning: BloomFilterH3 is not constructible from BloomFilterH3Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BloomFilterH3 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::bloom_filter::H3,
                             const BloomFilterH3Params &>> warning_instance;
} // namespace gem5_bloom_filter_H3_create
} // namespace gem5

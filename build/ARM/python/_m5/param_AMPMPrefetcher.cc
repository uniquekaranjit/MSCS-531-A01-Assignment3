...
namespace gem5
{
namespace gem5_prefetch_AMPM_create
{
...
template<>
struct [[deprecated(
        "Warning: AMPMPrefetcher is not constructible from AMPMPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is AMPMPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::AMPM,
                             const AMPMPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_AMPM_create
} // namespace gem5

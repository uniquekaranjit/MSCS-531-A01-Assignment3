...
template<>
struct [[deprecated(
        "Warning: I2CBus is not constructible from I2CBusParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is I2CBus has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::I2CBus,
                             const I2CBusParams &>> warning_instance;
} // namespace gem5_I2CBus_create
} // namespace gem5

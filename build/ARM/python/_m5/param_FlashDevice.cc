...
namespace gem5
{
namespace gem5_FlashDevice_create
{
...
template<>
struct [[deprecated(
        "Warning: FlashDevice is not constructible from FlashDeviceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is FlashDevice has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::FlashDevice,
                             const FlashDeviceParams &>> warning_instance;
} // namespace gem5_FlashDevice_create
} // namespace gem5

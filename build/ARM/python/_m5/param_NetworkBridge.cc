...
namespace gem5
{
namespace gem5_ruby_garnet_NetworkBridge_create
{
...
template<>
struct [[deprecated(
        "Warning: NetworkBridge is not constructible from NetworkBridgeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is NetworkBridge has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::garnet::NetworkBridge,
                             const NetworkBridgeParams &>> warning_instance;
} // namespace gem5_ruby_garnet_NetworkBridge_create
} // namespace gem5

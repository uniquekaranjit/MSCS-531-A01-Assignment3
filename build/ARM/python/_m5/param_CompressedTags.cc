...
namespace gem5
{
namespace gem5_CompressedTags_create
{
...
template<>
struct [[deprecated(
        "Warning: CompressedTags is not constructible from CompressedTagsParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CompressedTags has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::CompressedTags,
                             const CompressedTagsParams &>> warning_instance;
} // namespace gem5_CompressedTags_create
} // namespace gem5

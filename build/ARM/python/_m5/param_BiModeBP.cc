...
namespace gem5
{
namespace gem5_branch_prediction_BiModeBP_create
{
...
template<>
struct [[deprecated(
        "Warning: BiModeBP is not constructible from BiModeBPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BiModeBP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::BiModeBP,
                             const BiModeBPParams &>> warning_instance;
} // namespace gem5_branch_prediction_BiModeBP_create
} // namespace gem5

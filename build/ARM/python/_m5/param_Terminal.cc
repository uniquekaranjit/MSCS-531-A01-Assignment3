...
namespace gem5
{
namespace gem5_Terminal_create
{
...
template<>
struct [[deprecated(
        "Warning: Terminal is not constructible from TerminalParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Terminal has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::Terminal,
                             const TerminalParams &>> warning_instance;
} // namespace gem5_Terminal_create
} // namespace gem5

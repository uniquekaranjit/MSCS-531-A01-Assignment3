...
namespace gem5
{
namespace gem5_prefetch_SBOOE_create
{
...
template<>
struct [[deprecated(
        "Warning: SBOOEPrefetcher is not constructible from SBOOEPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SBOOEPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::SBOOE,
                             const SBOOEPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_SBOOE_create
} // namespace gem5

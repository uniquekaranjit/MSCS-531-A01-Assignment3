...
namespace gem5
{
namespace gem5_RubyTester_create
{
...
template<>
struct [[deprecated(
        "Warning: RubyTester is not constructible from RubyTesterParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is RubyTester has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::RubyTester,
                             const RubyTesterParams &>> warning_instance;
} // namespace gem5_RubyTester_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_compression_FPCD_create
{
...
template<>
struct [[deprecated(
        "Warning: FPCD is not constructible from FPCDParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is FPCD has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::FPCD,
                             const FPCDParams &>> warning_instance;
} // namespace gem5_compression_FPCD_create
} // namespace gem5

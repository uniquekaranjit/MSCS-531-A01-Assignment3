...
namespace gem5
{
namespace gem5_prefetch_IrregularStreamBuffer_create
{
...
template<>
struct [[deprecated(
        "Warning: IrregularStreamBufferPrefetcher is not constructible from IrregularStreamBufferPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is IrregularStreamBufferPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::IrregularStreamBuffer,
                             const IrregularStreamBufferPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_IrregularStreamBuffer_create
} // namespace gem5

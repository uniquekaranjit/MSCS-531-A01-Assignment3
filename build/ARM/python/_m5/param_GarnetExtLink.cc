...
namespace gem5
{
namespace gem5_ruby_garnet_GarnetExtLink_create
{
...
template<>
struct [[deprecated(
        "Warning: GarnetExtLink is not constructible from GarnetExtLinkParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GarnetExtLink has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::garnet::GarnetExtLink,
                             const GarnetExtLinkParams &>> warning_instance;
} // namespace gem5_ruby_garnet_GarnetExtLink_create
} // namespace gem5

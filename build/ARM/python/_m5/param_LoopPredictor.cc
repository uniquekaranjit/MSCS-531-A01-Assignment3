...
namespace gem5
{
namespace gem5_branch_prediction_LoopPredictor_create
{
...
template<>
struct [[deprecated(
        "Warning: LoopPredictor is not constructible from LoopPredictorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is LoopPredictor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::LoopPredictor,
                             const LoopPredictorParams &>> warning_instance;
} // namespace gem5_branch_prediction_LoopPredictor_create
} // namespace gem5

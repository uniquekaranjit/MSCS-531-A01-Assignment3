...
namespace gem5
{
namespace gem5_SetAssociative_create
{
...
template<>
struct [[deprecated(
        "Warning: SetAssociative is not constructible from SetAssociativeParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SetAssociative has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SetAssociative,
                             const SetAssociativeParams &>> warning_instance;
} // namespace gem5_SetAssociative_create
} // namespace gem5

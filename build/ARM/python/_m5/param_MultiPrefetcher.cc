...
namespace gem5
{
namespace gem5_prefetch_Multi_create
{
...
template<>
struct [[deprecated(
        "Warning: MultiPrefetcher is not constructible from MultiPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MultiPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::Multi,
                             const MultiPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_Multi_create
} // namespace gem5

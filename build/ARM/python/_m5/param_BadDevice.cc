...
namespace gem5
{
namespace gem5_BadDevice_create
{
...
template<>
struct [[deprecated(
        "Warning: BadDevice is not constructible from BadDeviceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BadDevice has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::BadDevice,
                             const BadDeviceParams &>> warning_instance;
} // namespace gem5_BadDevice_create
} // namespace gem5

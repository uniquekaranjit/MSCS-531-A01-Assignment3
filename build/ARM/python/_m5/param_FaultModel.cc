...
class DummyFaultModelShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const FaultModelParams &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::ruby::FaultModel *
DummyFaultModelShunt<gem5::ruby::FaultModel>::Params::create() const
{
    return DummyFaultModelShunt<gem5::ruby::FaultModel>::create(*this);
}
...
namespace gem5
{
namespace gem5_ruby_FaultModel_create
{
...
template<>
struct [[deprecated(
        "Warning: FaultModel is not constructible from FaultModelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is FaultModel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ruby::FaultModel,
                             const FaultModelParams &>> warning_instance;
} // namespace gem5_ruby_FaultModel_create
} // namespace gem5

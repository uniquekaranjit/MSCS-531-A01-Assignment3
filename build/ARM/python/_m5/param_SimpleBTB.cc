...
namespace gem5
{
namespace gem5_branch_prediction_SimpleBTB_create
{
...
template<>
struct [[deprecated(
        "Warning: SimpleBTB is not constructible from SimpleBTBParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimpleBTB has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::SimpleBTB,
                             const SimpleBTBParams &>> warning_instance;
} // namespace gem5_branch_prediction_SimpleBTB_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_CustomNoMaliGpu_create
{
...
template<>
struct [[deprecated(
        "Warning: CustomNoMaliGpu is not constructible from CustomNoMaliGpuParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CustomNoMaliGpu has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::CustomNoMaliGpu,
                             const CustomNoMaliGpuParams &>> warning_instance;
} // namespace gem5_CustomNoMaliGpu_create
} // namespace gem5

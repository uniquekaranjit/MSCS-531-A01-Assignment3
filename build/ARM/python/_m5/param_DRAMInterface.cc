...
namespace gem5
{
namespace gem5_memory_DRAMInterface_create
{
...
template<>
struct [[deprecated(
        "Warning: DRAMInterface is not constructible from DRAMInterfaceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is DRAMInterface has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::DRAMInterface,
                             const DRAMInterfaceParams &>> warning_instance;
} // namespace gem5_memory_DRAMInterface_create
} // namespace gem5

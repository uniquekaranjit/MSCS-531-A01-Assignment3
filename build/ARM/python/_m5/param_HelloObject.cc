...
namespace gem5
{
namespace gem5_HelloObject_create
{
...
template<>
struct [[deprecated(
        "Warning: HelloObject is not constructible from HelloObjectParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is HelloObject has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::HelloObject,
                             const HelloObjectParams &>> warning_instance;
} // namespace gem5_HelloObject_create
} // namespace gem5

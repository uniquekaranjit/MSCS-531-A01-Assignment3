...
namespace gem5
{
namespace gem5_GarnetSyntheticTraffic_create
{
...
template<>
struct [[deprecated(
        "Warning: GarnetSyntheticTraffic is not constructible from GarnetSyntheticTrafficParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GarnetSyntheticTraffic has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GarnetSyntheticTraffic,
                             const GarnetSyntheticTrafficParams &>> warning_instance;
} // namespace gem5_GarnetSyntheticTraffic_create
} // namespace gem5

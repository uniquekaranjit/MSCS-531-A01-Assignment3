...
namespace gem5
{
namespace gem5_GenericTimerMem_create
{
...
template<>
struct [[deprecated(
        "Warning: GenericTimerMem is not constructible from GenericTimerMemParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GenericTimerMem has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GenericTimerMem,
                             const GenericTimerMemParams &>> warning_instance;
} // namespace gem5_GenericTimerMem_create
} // namespace gem5

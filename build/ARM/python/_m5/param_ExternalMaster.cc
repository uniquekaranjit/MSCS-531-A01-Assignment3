...
namespace gem5
{
namespace gem5_ExternalMaster_create
{
...
template<>
struct [[deprecated(
        "Warning: ExternalMaster is not constructible from ExternalMasterParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ExternalMaster has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ExternalMaster,
                             const ExternalMasterParams &>> warning_instance;
} // namespace gem5_ExternalMaster_create
} // namespace gem5

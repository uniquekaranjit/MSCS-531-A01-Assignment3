...
namespace gem5
{
namespace gem5_MinorFUTiming_create
{
...
template<>
struct [[deprecated(
        "Warning: MinorFUTiming is not constructible from MinorFUTimingParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MinorFUTiming has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MinorFUTiming,
                             const MinorFUTimingParams &>> warning_instance;
} // namespace gem5_MinorFUTiming_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_GenericPciHost_create
{
...
template<>
struct [[deprecated(
        "Warning: GenericPciHost is not constructible from GenericPciHostParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is GenericPciHost has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::GenericPciHost,
                             const GenericPciHostParams &>> warning_instance;
} // namespace gem5_GenericPciHost_create
} // namespace gem5

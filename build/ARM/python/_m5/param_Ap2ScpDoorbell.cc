...
namespace gem5
{
namespace gem5_Ap2ScpDoorbell_create
{
...
template<>
struct [[deprecated(
        "Warning: Ap2ScpDoorbell is not constructible from Ap2ScpDoorbellParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Ap2ScpDoorbell has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::Ap2ScpDoorbell,
                             const Ap2ScpDoorbellParams &>> warning_instance;
} // namespace gem5_Ap2ScpDoorbell_create
} // namespace gem5

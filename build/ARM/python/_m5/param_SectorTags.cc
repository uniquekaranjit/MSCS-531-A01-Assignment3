...
class DummySectorTagsShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const SectorTagsParams &>>>
{
  public:
...
{
    return DummySectorTagsShunt<gem5::SectorTags>::create(*this);
}
...
namespace gem5
{
namespace gem5_SectorTags_create
{
...
template<>
struct [[deprecated(
        "Warning: SectorTags is not constructible from SectorTagsParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SectorTags has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SectorTags,
                             const SectorTagsParams &>> warning_instance;
} // namespace gem5_SectorTags_create
} // namespace gem5

...
py::module_ m = m_internal.def_submodule("param_ArmISA");
    py::class_<ArmISAParams, BaseISAParams, std::unique_ptr<ArmISAParams, py::nodelete>>(m, "ArmISAParams")
        ...
        .def_readwrite("mpamidr_el1", &ArmISAParams::mpamidr_el1)
        .def_readwrite("pmu", &ArmISAParams::pmu)
        .def_readwrite("release_se", &ArmISAParams::release_se)
        .def_readwrite("sme_vl_se", &ArmISAParams::sme_vl_se)
...
namespace gem5
{
namespace gem5_ArmISA_ISA_create
{
...
template<>
struct [[deprecated(
        "Warning: ArmISA is not constructible from ArmISAParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ArmISA has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::ArmISA::ISA,
                             const ArmISAParams &>> warning_instance;
} // namespace gem5_ArmISA_ISA_create
} // namespace gem5

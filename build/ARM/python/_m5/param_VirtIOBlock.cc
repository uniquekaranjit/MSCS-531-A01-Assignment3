...
namespace gem5
{
namespace gem5_VirtIOBlock_create
{
...
template<>
struct [[deprecated(
        "Warning: VirtIOBlock is not constructible from VirtIOBlockParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is VirtIOBlock has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::VirtIOBlock,
                             const VirtIOBlockParams &>> warning_instance;
} // namespace gem5_VirtIOBlock_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_PciBarNone_create
{
...
template<>
struct [[deprecated(
        "Warning: PciBarNone is not constructible from PciBarNoneParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PciBarNone has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PciBarNone,
                             const PciBarNoneParams &>> warning_instance;
} // namespace gem5_PciBarNone_create
} // namespace gem5

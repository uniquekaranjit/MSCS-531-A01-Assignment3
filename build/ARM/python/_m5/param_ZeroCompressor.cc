...
namespace gem5
{
namespace gem5_compression_Zero_create
{
...
template<>
struct [[deprecated(
        "Warning: ZeroCompressor is not constructible from ZeroCompressorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ZeroCompressor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Zero,
                             const ZeroCompressorParams &>> warning_instance;
} // namespace gem5_compression_Zero_create
} // namespace gem5

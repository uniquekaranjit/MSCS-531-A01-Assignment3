...
namespace gem5
{
namespace gem5_replacement_policy_BIP_create
{
...
template<>
struct [[deprecated(
        "Warning: BIPRP is not constructible from BIPRPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BIPRP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::BIP,
                             const BIPRPParams &>> warning_instance;
} // namespace gem5_replacement_policy_BIP_create
} // namespace gem5

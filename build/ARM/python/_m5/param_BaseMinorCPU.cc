...
namespace gem5
{
namespace gem5_MinorCPU_create
{
...
template<>
struct [[deprecated(
        "Warning: BaseMinorCPU is not constructible from BaseMinorCPUParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BaseMinorCPU has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MinorCPU,
                             const BaseMinorCPUParams &>> warning_instance;
} // namespace gem5_MinorCPU_create
} // namespace gem5

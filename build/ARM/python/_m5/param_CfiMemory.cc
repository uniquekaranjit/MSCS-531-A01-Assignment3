...
namespace gem5
{
namespace gem5_memory_CfiMemory_create
{
...
template<>
struct [[deprecated(
        "Warning: CfiMemory is not constructible from CfiMemoryParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CfiMemory has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::CfiMemory,
                             const CfiMemoryParams &>> warning_instance;
} // namespace gem5_memory_CfiMemory_create
} // namespace gem5

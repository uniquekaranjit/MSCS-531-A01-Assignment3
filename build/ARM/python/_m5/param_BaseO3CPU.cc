...
py::module_ m = m_internal.def_submodule("param_BaseO3CPU");
    py::class_<BaseO3CPUParams, BaseCPUParams, std::unique_ptr<BaseO3CPUParams, py::nodelete>>(m, "BaseO3CPUParams")
        ...
        .def_readwrite("SSITAssoc", &BaseO3CPUParams::SSITAssoc)
        .def_readwrite("SSITIndexingPolicy", &BaseO3CPUParams::SSITIndexingPolicy)
        .def_readwrite("SSITReplPolicy", &BaseO3CPUParams::SSITReplPolicy)
        ...
        .def_readwrite("numPhysMatRegs", &BaseO3CPUParams::numPhysMatRegs)
        ...
        .def_readwrite("recvRespBufferSize", &BaseO3CPUParams::recvRespBufferSize)
        .def_readwrite("recvRespMaxCachelines", &BaseO3CPUParams::recvRespMaxCachelines)
        .def_readwrite("recvRespThrottling", &BaseO3CPUParams::recvRespThrottling)
...
template<>
struct [[deprecated(
        "Warning: BaseO3CPU is not constructible from BaseO3CPUParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BaseO3CPU has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::o3::CPU,
                             const BaseO3CPUParams &>> warning_instance;
} // namespace gem5_o3_CPU_create
} // namespace gem5

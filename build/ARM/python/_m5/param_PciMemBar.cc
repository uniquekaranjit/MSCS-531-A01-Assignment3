...
namespace gem5
{
namespace gem5_PciMemBar_create
{
...
template<>
struct [[deprecated(
        "Warning: PciMemBar is not constructible from PciMemBarParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PciMemBar has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PciMemBar,
                             const PciMemBarParams &>> warning_instance;
} // namespace gem5_PciMemBar_create
} // namespace gem5

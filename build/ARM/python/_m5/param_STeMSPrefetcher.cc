...
namespace gem5
{
namespace gem5_prefetch_STeMS_create
{
...
template<>
struct [[deprecated(
        "Warning: STeMSPrefetcher is not constructible from STeMSPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is STeMSPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::STeMS,
                             const STeMSPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_STeMS_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_branch_prediction_MPP_LoopPredictor_create
{
...
template<>
struct [[deprecated(
        "Warning: MPP_LoopPredictor is not constructible from MPP_LoopPredictorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MPP_LoopPredictor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::MPP_LoopPredictor,
                             const MPP_LoopPredictorParams &>> warning_instance;
} // namespace gem5_branch_prediction_MPP_LoopPredictor_create
} // namespace gem5

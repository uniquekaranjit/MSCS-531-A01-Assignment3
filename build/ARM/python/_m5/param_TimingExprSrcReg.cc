...
namespace gem5
{
namespace gem5_TimingExprSrcReg_create
{
...
template<>
struct [[deprecated(
        "Warning: TimingExprSrcReg is not constructible from TimingExprSrcRegParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TimingExprSrcReg has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingExprSrcReg,
                             const TimingExprSrcRegParams &>> warning_instance;
} // namespace gem5_TimingExprSrcReg_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_TimingExprBin_create
{
...
template<>
struct [[deprecated(
        "Warning: TimingExprBin is not constructible from TimingExprBinParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TimingExprBin has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::TimingExprBin,
                             const TimingExprBinParams &>> warning_instance;
} // namespace gem5_TimingExprBin_create
} // namespace gem5

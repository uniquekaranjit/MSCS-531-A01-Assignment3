...
py::module_ m = m_internal.def_submodule("param_TAGEBase");
    py::class_<TAGEBaseParams, SimObjectParams, std::unique_ptr<TAGEBaseParams, py::nodelete>>(m, "TAGEBaseParams")
        ...
        .def_readwrite("takenOnlyHistory", &TAGEBaseParams::takenOnlyHistory)
...
namespace gem5
{
namespace gem5_branch_prediction_TAGEBase_create
{
...
template<>
struct [[deprecated(
        "Warning: TAGEBase is not constructible from TAGEBaseParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TAGEBase has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::TAGEBase,
                             const TAGEBaseParams &>> warning_instance;
} // namespace gem5_branch_prediction_TAGEBase_create
} // namespace gem5

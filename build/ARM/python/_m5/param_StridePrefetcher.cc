...
py::module_ m = m_internal.def_submodule("param_StridePrefetcher");
    py::class_<StridePrefetcherParams, QueuedPrefetcherParams, std::unique_ptr<StridePrefetcherParams, py::nodelete>>(m, "StridePrefetcherParams")
        ...
        .def_readwrite("distance", &StridePrefetcherParams::distance)
        ...
        .def_readwrite("use_cache_line_address", &StridePrefetcherParams::use_cache_line_address)
...
namespace gem5
{
namespace gem5_prefetch_Stride_create
{
...
template<>
struct [[deprecated(
        "Warning: StridePrefetcher is not constructible from StridePrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is StridePrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::Stride,
                             const StridePrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_Stride_create
} // namespace gem5

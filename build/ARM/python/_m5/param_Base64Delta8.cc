...
namespace gem5
{
namespace gem5_compression_Base64Delta8_create
{
...
template<>
struct [[deprecated(
        "Warning: Base64Delta8 is not constructible from Base64Delta8Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Base64Delta8 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Base64Delta8,
                             const Base64Delta8Params &>> warning_instance;
} // namespace gem5_compression_Base64Delta8_create
} // namespace gem5

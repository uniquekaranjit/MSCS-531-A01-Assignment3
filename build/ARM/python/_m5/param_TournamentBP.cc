...
class DummyTournamentBPShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const TournamentBPParams &>>>
{
  public:
...
{
    return DummyTournamentBPShunt<gem5::branch_prediction::TournamentBP>::create(*this);
}
...
namespace gem5
{
namespace gem5_branch_prediction_TournamentBP_create
{
...
template<>
struct [[deprecated(
        "Warning: TournamentBP is not constructible from TournamentBPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TournamentBP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::branch_prediction::TournamentBP,
                             const TournamentBPParams &>> warning_instance;
} // namespace gem5_branch_prediction_TournamentBP_create
} // namespace gem5

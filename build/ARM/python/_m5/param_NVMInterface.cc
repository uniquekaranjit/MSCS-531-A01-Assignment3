...
namespace gem5
{
namespace gem5_memory_NVMInterface_create
{
...
template<>
struct [[deprecated(
        "Warning: NVMInterface is not constructible from NVMInterfaceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is NVMInterface has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::memory::NVMInterface,
                             const NVMInterfaceParams &>> warning_instance;
} // namespace gem5_memory_NVMInterface_create
} // namespace gem5

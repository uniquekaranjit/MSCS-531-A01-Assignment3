...
namespace gem5
{
namespace gem5_bloom_filter_Multi_create
{
...
template<>
struct [[deprecated(
        "Warning: BloomFilterMulti is not constructible from BloomFilterMultiParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BloomFilterMulti has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::bloom_filter::Multi,
                             const BloomFilterMultiParams &>> warning_instance;
} // namespace gem5_bloom_filter_Multi_create
} // namespace gem5

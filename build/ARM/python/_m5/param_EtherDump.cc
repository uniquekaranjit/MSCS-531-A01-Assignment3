...
class DummyEtherDumpShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const EtherDumpParams &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::EtherDump *
DummyEtherDumpShunt<gem5::EtherDump>::Params::create() const
{
    return DummyEtherDumpShunt<gem5::EtherDump>::create(*this);
}
...
namespace gem5
{
namespace gem5_EtherDump_create
{
...
template<>
struct [[deprecated(
        "Warning: EtherDump is not constructible from EtherDumpParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is EtherDump has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::EtherDump,
                             const EtherDumpParams &>> warning_instance;
} // namespace gem5_EtherDump_create
} // namespace gem5

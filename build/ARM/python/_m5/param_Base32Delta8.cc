...
class DummyBase32Delta8Shunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const Base32Delta8Params &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::compression::Base32Delta8 *
DummyBase32Delta8Shunt<gem5::compression::Base32Delta8>::Params::create() const
{
    return DummyBase32Delta8Shunt<gem5::compression::Base32Delta8>::create(*this);
}
...
namespace gem5
{
namespace gem5_compression_Base32Delta8_create
{
...
template<>
struct [[deprecated(
        "Warning: Base32Delta8 is not constructible from Base32Delta8Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Base32Delta8 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Base32Delta8,
                             const Base32Delta8Params &>> warning_instance;
} // namespace gem5_compression_Base32Delta8_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_SimPoint_create
{
...
template<>
struct [[deprecated(
        "Warning: SimPoint is not constructible from SimPointParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimPoint has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SimPoint,
                             const SimPointParams &>> warning_instance;
} // namespace gem5_SimPoint_create
} // namespace gem5

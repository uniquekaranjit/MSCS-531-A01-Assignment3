...
namespace gem5
{
namespace gem5_prefetch_Tagged_create
{
...
template<>
struct [[deprecated(
        "Warning: TaggedPrefetcher is not constructible from TaggedPrefetcherParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is TaggedPrefetcher has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::Tagged,
                             const TaggedPrefetcherParams &>> warning_instance;
} // namespace gem5_prefetch_Tagged_create
} // namespace gem5

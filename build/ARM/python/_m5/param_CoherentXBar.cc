...
namespace gem5
{
namespace gem5_CoherentXBar_create
{
...
template<>
struct [[deprecated(
        "Warning: CoherentXBar is not constructible from CoherentXBarParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is CoherentXBar has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::CoherentXBar,
                             const CoherentXBarParams &>> warning_instance;
} // namespace gem5_CoherentXBar_create
} // namespace gem5

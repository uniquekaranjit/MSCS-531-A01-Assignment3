...
template<>
struct [[deprecated(
        "Warning: SMMUv3 is not constructible from SMMUv3Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SMMUv3 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SMMUv3,
                             const SMMUv3Params &>> warning_instance;
} // namespace gem5_SMMUv3_create
} // namespace gem5

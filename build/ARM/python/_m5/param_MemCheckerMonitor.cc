...
namespace gem5
{
namespace gem5_MemCheckerMonitor_create
{
...
template<>
struct [[deprecated(
        "Warning: MemCheckerMonitor is not constructible from MemCheckerMonitorParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is MemCheckerMonitor has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::MemCheckerMonitor,
                             const MemCheckerMonitorParams &>> warning_instance;
} // namespace gem5_MemCheckerMonitor_create
} // namespace gem5

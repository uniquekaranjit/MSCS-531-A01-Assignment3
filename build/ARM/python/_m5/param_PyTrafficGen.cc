...
namespace gem5
{
namespace gem5_PyTrafficGen_create
{
...
template<>
struct [[deprecated(
        "Warning: PyTrafficGen is not constructible from PyTrafficGenParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PyTrafficGen has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PyTrafficGen,
                             const PyTrafficGenParams &>> warning_instance;
} // namespace gem5_PyTrafficGen_create
} // namespace gem5

...
class DummyBase64Delta32Shunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const Base64Delta32Params &>>>
{
  public:
...
{
    return DummyBase64Delta32Shunt<gem5::compression::Base64Delta32>::create(*this);
}
...
namespace gem5
{
namespace gem5_compression_Base64Delta32_create
{
...
template<>
struct [[deprecated(
        "Warning: Base64Delta32 is not constructible from Base64Delta32Params. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is Base64Delta32 has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::compression::Base64Delta32,
                             const Base64Delta32Params &>> warning_instance;
} // namespace gem5_compression_Base64Delta32_create
} // namespace gem5

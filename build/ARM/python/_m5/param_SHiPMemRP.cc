...
namespace gem5
{
namespace gem5_replacement_policy_SHiPMem_create
{
...
template<>
struct [[deprecated(
        "Warning: SHiPMemRP is not constructible from SHiPMemRPParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SHiPMemRP has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::replacement_policy::SHiPMem,
                             const SHiPMemRPParams &>> warning_instance;
} // namespace gem5_replacement_policy_SHiPMem_create
} // namespace gem5

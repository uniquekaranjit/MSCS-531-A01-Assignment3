...
namespace gem5
{
namespace gem5_PciIoBar_create
{
...
template<>
struct [[deprecated(
        "Warning: PciIoBar is not constructible from PciIoBarParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is PciIoBar has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::PciIoBar,
                             const PciIoBarParams &>> warning_instance;
} // namespace gem5_PciIoBar_create
} // namespace gem5

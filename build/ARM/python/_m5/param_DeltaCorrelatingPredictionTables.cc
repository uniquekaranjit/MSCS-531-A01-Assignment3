...
namespace gem5
{
namespace gem5_prefetch_DeltaCorrelatingPredictionTables_create
{
...
template<>
struct [[deprecated(
        "Warning: DeltaCorrelatingPredictionTables is not constructible from DeltaCorrelatingPredictionTablesParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is DeltaCorrelatingPredictionTables has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::prefetch::DeltaCorrelatingPredictionTables,
                             const DeltaCorrelatingPredictionTablesParams &>> warning_instance;
} // namespace gem5_prefetch_DeltaCorrelatingPredictionTables_create
} // namespace gem5

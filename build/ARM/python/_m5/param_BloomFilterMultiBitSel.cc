...
namespace gem5
{
namespace gem5_bloom_filter_MultiBitSel_create
{
...
template<>
struct [[deprecated(
        "Warning: BloomFilterMultiBitSel is not constructible from BloomFilterMultiBitSelParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is BloomFilterMultiBitSel has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::bloom_filter::MultiBitSel,
                             const BloomFilterMultiBitSelParams &>> warning_instance;
} // namespace gem5_bloom_filter_MultiBitSel_create
} // namespace gem5

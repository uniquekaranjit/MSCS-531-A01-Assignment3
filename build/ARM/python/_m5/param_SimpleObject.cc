...
namespace gem5
{
namespace gem5_SimpleObject_create
{
...
template<>
struct [[deprecated(
        "Warning: SimpleObject is not constructible from SimpleObjectParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is SimpleObject has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::SimpleObject,
                             const SimpleObjectParams &>> warning_instance;
} // namespace gem5_SimpleObject_create
} // namespace gem5

...
namespace gem5
{
namespace gem5_o3_ElasticTrace_create
{
...
template<>
struct [[deprecated(
        "Warning: ElasticTrace is not constructible from ElasticTraceParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is ElasticTrace has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::o3::ElasticTrace,
                             const ElasticTraceParams &>> warning_instance;
} // namespace gem5_o3_ElasticTrace_create
} // namespace gem5

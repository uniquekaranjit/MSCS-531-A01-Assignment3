...
namespace gem5
{
namespace gem5_NoncoherentXBar_create
{
...
template<>
struct [[deprecated(
        "Warning: NoncoherentXBar is not constructible from NoncoherentXBarParams. "
        "It is deprecated to use non-standard `create()` methods. "
        "If you see this warning followed by a linking error, "
        "the most likely problem is NoncoherentXBar has a parent class with "
        "pure virtual functions.")]] NonDefaultCreate<true> {};

[[maybe_unused]] NonDefaultCreate<
    !std::is_constructible_v<gem5::NoncoherentXBar,
                             const NoncoherentXBarParams &>> warning_instance;
} // namespace gem5_NoncoherentXBar_create
} // namespace gem5

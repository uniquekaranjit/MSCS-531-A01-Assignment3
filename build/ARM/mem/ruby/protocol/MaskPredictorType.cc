...
::std::ostream&
operator<<(::std::ostream& out, const MaskPredictorType& obj)
{
...
MaskPredictorType_to_string(const MaskPredictorType& obj)
{
    switch(obj) {
      ...
      case MaskPredictorType_NUM:
        return "NUM (invalid)";
      default:
        panic("Invalid value for type MaskPredictorType %d\n", obj);
    }
...
MaskPredictorType
string_to_MaskPredictorType(const std::string& str)
{
    if (str == "Undefined") {

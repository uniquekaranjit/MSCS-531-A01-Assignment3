...
{
  public:
SequencerMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_writeMask(blockSize)
		, m_DataBlk(blockSize)
{
        setRubySystem(rs);
    ...
    SequencerMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_LineAddress, const Addr& local_PhysicalAddress, const SequencerRequestType& local_Type, const Addr& local_ProgramCounter, const RubyAccessMode& local_AccessMode, const WriteMask& local_writeMask, const DataBlock& local_DataBlk, const int& local_Len, const PrefetchBit& local_Prefetch, const MessageSizeType& local_MessageSize)
    ...
    void initBlockSize(int block_size)
    {
    	...
    	m_writeMask.setBlockSize(block_size);

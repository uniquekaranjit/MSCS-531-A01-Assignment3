...
::std::ostream&
operator<<(::std::ostream& out, const MessageSizeType& obj)
{
...
MessageSizeType_to_string(const MessageSizeType& obj)
{
    switch(obj) {
      ...
      case MessageSizeType_NUM:
        return "NUM (invalid)";
      default:
        panic("Invalid value for type MessageSizeType %d\n", obj);
    }
...
MessageSizeType
string_to_MessageSizeType(const std::string& str)
{
    if (str == "Control") {

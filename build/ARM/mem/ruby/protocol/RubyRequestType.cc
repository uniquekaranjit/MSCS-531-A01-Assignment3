...
RubyRequestType_to_string(const RubyRequestType& obj)
{
    switch(obj) {
      ...
      case RubyRequestType_hasNoAddr:
        return "hasNoAddr";
      case RubyRequestType_NUM:
        return "NUM (invalid)";
      default:
        panic("Invalid value for type RubyRequestType %d\n", obj);
    }
...
string_to_RubyRequestType(const std::string& str)
{
    ...
    } else if (str == "hasNoAddr") {
        return RubyRequestType_hasNoAddr;
    } else {

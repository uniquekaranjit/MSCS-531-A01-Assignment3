...
{
  public:
MemoryMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_DataBlk(blockSize)
{
        setRubySystem(rs);
    ...
    MemoryMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_addr, const MemoryRequestType& local_Type, const MachineID& local_Sender, const MachineID& local_OriginalRequestorMachId, const DataBlock& local_DataBlk, const MessageSizeType& local_MessageSize, const int& local_Len, const PrefetchBit& local_Prefetch, const bool& local_ReadX, const int& local_Acks, const bool& local_isGLCSet, const bool& local_isSLCSet)
    		...
    		, m_DataBlk(blockSize)
    {
        ...
        m_ReadX = local_ReadX;
        m_Acks = local_Acks;
        m_isGLCSet = local_isGLCSet;
        m_isSLCSet = local_isSLCSet;
    }
    MsgPtr
    clone() const
    {
    ...
    /** \brief Const accessor method for isGLCSet field.
     *  \return isGLCSet field
     */
    const bool&
    getisGLCSet() const
    {
    ...
    /** \brief Const accessor method for isSLCSet field.
     *  \return isSLCSet field
     */
    const bool&
    getisSLCSet() const
    {
    ...
    /** \brief Non-const accessor method for isGLCSet field.
     *  \return isGLCSet field
     */
    bool&
    getisGLCSet()
    ...
    /** \brief Non-const accessor method for isSLCSet field.
     *  \return isSLCSet field
     */
    bool&
    getisSLCSet()
    ...
    /** \brief Mutator method for isGLCSet field */
    void
    setisGLCSet(const bool& local_isGLCSet)
    {
        m_isGLCSet = local_isGLCSet;
    }
    /** \brief Mutator method for isSLCSet field */
    void
    setisSLCSet(const bool& local_isSLCSet)
    {
        m_isSLCSet = local_isSLCSet;
    }

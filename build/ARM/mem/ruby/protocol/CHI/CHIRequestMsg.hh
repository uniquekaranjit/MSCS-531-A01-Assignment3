...
#ifndef __CHI_CHIRequestMsg_HH__
#define __CHI_CHIRequestMsg_HH__
...
{
  public:
CHIRequestMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_atomic_op(blockSize)
{
        setRubySystem(rs);
    ...
    CHIRequestMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_addr, const Addr& local_accAddr, const int& local_accSize, const CHIRequestType& local_type, const MachineID& local_requestor, const MachineID& local_fwdRequestor, const bool& local_dataToFwdRequestor, const bool& local_retToSrc, const bool& local_allowRetry, const NetDest& local_Destination, const RequestPtr& local_seqReq, const bool& local_isSeqReqValid, const bool& local_is_local_pf, const bool& local_is_remote_pf, const WriteMask& local_atomic_op, const bool& local_usesTxnId, const Addr& local_txnId, const bool& local_ns, const MessageSizeType& local_MessageSize)
...
#endif // __CHI_CHIRequestMsg_HH__

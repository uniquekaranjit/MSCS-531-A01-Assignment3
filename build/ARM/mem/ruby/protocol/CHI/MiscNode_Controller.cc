    ...
    : AbstractController(p)
{
    ...
    p.ruby_system->m_num_controllers[MachineType_MiscNode]++;
...
MiscNode_Controller::regStats()
{
    ...
    if (m_version == 0) {
        ...
        for (MiscNode_Event event = MiscNode_Event_FIRST;
            ...
            int num_controllers =
                m_ruby_system->m_num_controllers[MachineType_MiscNode];
    ...
    const std::vector<MiscNode_Event> out_trans_evs = {MiscNode_Event_DvmTlbi_Initiate,MiscNode_Event_DvmSync_Initiate};
    const std::vector<MiscNode_Event> in_trans_evs = {MiscNode_Event_DvmTlbi_Initiate,MiscNode_Event_DvmSync_Initiate};
    const std::unordered_map<MiscNode_Event, std::vector<MiscNode_State>>
                                in_trans_evs_states = {{MiscNode_Event_DvmTlbi_Initiate, {MiscNode_State_Unallocated}},{MiscNode_Event_DvmSync_Initiate, {MiscNode_State_Unallocated}}};
    ...
    for (const auto event : in_trans_evs) {
        std::string stat_name =
            "inTransLatHist." + MiscNode_Event_to_string(event);
        statistics::Histogram* t =
            new statistics::Histogram(&stats, stat_name.c_str());
        ...
        for (const auto initial_state : in_trans_evs_states.at(event)) {
            ...
            for (MiscNode_State final_state = MiscNode_State_FIRST;
                ...
                std::string stat_name = "inTransLatHist." +
                    ...
                    MiscNode_State_to_string(final_state) + ".total";
                statistics::Scalar* t =
...
if (!(((*in_msg_ptr)).m_usesTxnId)) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:45: %s for machine %s.\n", "assert failure", name());
...
if (!((((*in_msg_ptr)).m_txnId == addr))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:46: %s for machine %s.\n", "assert failure", name());
...
if (!((((*in_msg_ptr)).m_is_local_pf == (false)))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:47: %s for machine %s.\n", "assert failure", name());
...
if (!(((*in_msg_ptr)).m_allowRetry)) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:48: %s for machine %s.\n", "assert failure", name());
...
bool isNonSync
 = (((*in_msg_ptr)).m_type == CHIRequestType_DvmOpNonSync);
    if ((((*m_storDvmTBEs_ptr)).areNSlotsAvailable((1), (tbePartition(isNonSync))))) {
        ...
        {
            std::shared_ptr<MiscNode_RetryTriggerMsg> out_msg = std::make_shared<MiscNode_RetryTriggerMsg>(clockEdge(),     m_ruby_system->getBlockSizeBytes(), m_ruby_system);
            ...
            ((*m_retryTriggerQueue_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_retry_ack_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
        }
    }
    }
...
if (!((((*in_msg_ptr)).m_allowRetry == (false)))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:87: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!(((*in_msg_ptr)).m_usesTxnId)) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:88: %s for machine %s.\n", "assert failure", name());
...
;
{
    ...
    #ifndef NDEBUG
    if (!((((*in_msg_ptr)).m_txnId == addr))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:90: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::Receive_ReqDataResp(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:117: %s for machine %s.\n", "assert failure", name());
...
if (!((((*m_tbe_ptr).m_expected_req_resp).hasExpected()))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:118: %s for machine %s.\n", "assert failure", name());
...
;
{
    ...
    if (((((*m_tbe_ptr).m_expected_req_resp).receiveData(((*in_msg_ptr)).m_type)) == (false))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:122: %s for machine %s.\n", ("Received unexpected message"), name());
        ;
    }
    #ifndef NDEBUG
    if (!((! (((*m_tbe_ptr).m_expected_req_resp).hasExpected())))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:124: %s for machine %s.\n", "assert failure", name());
    ...
    if (!((! (((*m_tbe_ptr).m_expected_snp_resp).hasExpected())))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:129: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::Receive_SnpResp(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((((*m_tbe_ptr).m_expected_snp_resp).hasExpected()))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:140: %s for machine %s.\n", "assert failure", name());
...
;
{
    ...
    if (((((*m_tbe_ptr).m_expected_snp_resp).receiveResp(((*in_msg_ptr)).m_type)) == (false))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:144: %s for machine %s.\n", ("Received unexpected message"), name());
        ;
    }
    #ifndef NDEBUG
    if (!((((*in_msg_ptr)).m_stale == (false)))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:146: %s for machine %s.\n", "assert failure", name());
    ...
    if (!((((*m_tbe_ptr).m_pendingTargets).isElement(((*in_msg_ptr)).m_responder)))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:151: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::ProcessNextState(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:161: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::ProcessNextState_ClearPending(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:170: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::Send_Comp(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:176: %s for machine %s.\n", "assert failure", name());
 ...
 = CHIResponseType_Comp;
{
    ...
    ((*m_rspOut_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
MiscNode_Controller::Send_Comp_NonSync(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:192: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::Finalize_DeallocateRequest(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:225: %s for machine %s.\n", "assert failure", name());
...
if (!((((*m_tbe_ptr).m_actions).empty()))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:226: %s for machine %s.\n", "assert failure", name());
...
CHIRequestType type
 = CHIRequestType_SnpDvmOpSync_P1;
    ...
    if (!(((((*m_tbe_ptr).m_notSentTargets).count()) > (0)))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:310: %s for machine %s.\n", "assert failure", name());
     ...
     = (((*m_tbe_ptr).m_notSentTargets).smallestElement());
    {
        ...
        ((*m_snpOut_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
    }
...
CHIRequestType type
 = CHIRequestType_SnpDvmOpSync_P2;
    ...
    #ifndef NDEBUG
    if (!(((((*m_tbe_ptr).m_notSentTargets).count()) > (0)))) {
        panic("Runtime Error at CHI-dvm-misc-node-actions.sm:341: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::Profile_OutgoingEnd_DVM(MiscNode_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-actions.sm:389: %s for machine %s.\n", "assert failure", name());
...
bool
MiscNode_Controller::inCache(const Addr& param_txnId, const bool& param_is_secure)
{
return (false);

}
bool
MiscNode_Controller::hasBeenPrefetched(const Addr& param_txnId, const bool& param_is_secure, const RequestorID& param_requestor)
{
return (false);

}
bool
MiscNode_Controller::hasBeenPrefetched(const Addr& param_txnId, const bool& param_is_secure)
{
return (false);

}
bool
MiscNode_Controller::inMissQueue(const Addr& param_txnId, const bool& param_is_secure)
{
return (false);
...
{
DPRINTF(RubySlicc, "CHI-dvm-misc-node-funcs.sm:158: Unused notifyCoalesced(txnId=%#x, type=%s, was_miss=%d)\n", param_txnId, param_type, param_was_miss);
    ...
    if ((param_type == CHIRequestType_DvmOpNonSync)) {
        return MiscNode_Event_DvmTlbi_Initiate;
            ...
            if ((param_type == CHIRequestType_DvmOpSync)) {
                ...
                panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:171: %s for machine %s.\n", ("Invalid/unexpected CHIRequestType"), name());
                ;
            }
        }
...
MiscNode_Controller::respToEvent(const CHIResponseType& param_type)
{
    if ((param_type == CHIResponseType_SnpResp_I)) {
        ...
        panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:179: %s for machine %s.\n", ("Invalid/unexpected CHIResponseType"), name());
        ;
    }
...
MiscNode_Controller::dataToEvent(const CHIDataType& param_type)
{
    if ((param_type == CHIDataType_NCBWrData)) {
        ...
        panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:187: %s for machine %s.\n", ("Invalid/unexpected CHIDataType"), name());
        ;
    }
...
if (!(((*m_blockSize_ptr) >= m_data_channel_size))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:195: %s for machine %s.\n", "assert failure", name());
...
if (!((((*m_blockSize_ptr) % m_data_channel_size) == (0)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:196: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!(((*m_blockSize_ptr) >= m_data_channel_size))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:201: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((((*m_blockSize_ptr) % m_data_channel_size) == (0)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:202: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((param_tbe != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:207: %s for machine %s.\n", "assert failure", name());
...
{
DPRINTF(RubySlicc, "CHI-dvm-misc-node-funcs.sm:241: allocateDvmRequestTBE %x %016llx\n", (param_in_msg).m_type, param_txnId);
bool isNonSync
...
if (!((((*m_storDvmTBEs_ptr)).areNSlotsAvailable((1), partition)))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:248: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((param_tbe != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-funcs.sm:269: %s for machine %s.\n", "assert failure", name());
...
MiscNode_Controller::processRetryQueue()
{
    if ((((*m_storDvmTBEs_ptr)).hasPossibleRetry())) {
        ...
        (((*m_storDvmTBEs_ptr)).incrementReserved((tbePartition((toRetry).m_isNonSync))));
        {
            ...
            ((*m_retryTriggerQueue_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_crd_grant_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
        }
    }
...
{
panic("Runtime Error at CHI-dvm-misc-node-ports.sm:79: %s for machine %s.\n", ("rspInPort must never stall\n"), name());
;
return (false);
...
{
panic("Runtime Error at CHI-dvm-misc-node-ports.sm:97: %s for machine %s.\n", ("datInPort must never stall\n"), name());
;
return (false);
...
{
panic("Runtime Error at CHI-dvm-misc-node-ports.sm:111: %s for machine %s.\n", ("snpInPort must never stall\n"), name());
;
return (false);
...
{
panic("Runtime Error at CHI-dvm-misc-node-ports.sm:133: %s for machine %s.\n", ("reqInPort must never stall\n"), name());
;
return (false);
...
#ifndef NDEBUG
if (!((param_tbe != NULL))) {
    panic("Runtime Error at CHI-dvm-misc-node-ports.sm:231: %s for machine %s.\n", "assert failure", name());
             ...
             = (intToCycles((0)));
                ...
                (*param_tbe).m_pendAction = MiscNode_Event_null;
                    ...
                    if (!(((*param_tbe).m_pendAction != MiscNode_Event_null))) {
                        panic("Runtime Error at CHI-dvm-misc-node-ports.sm:275: %s for machine %s.\n", "assert failure", name());

                    }
                    #endif
                    ;
                    {
                        std::shared_ptr<MiscNode_TriggerMsg> out_msg = std::make_shared<MiscNode_TriggerMsg>(clockEdge(),     m_ruby_system->getBlockSizeBytes(), m_ruby_system);

...
Cache_Event_to_string(const Cache_Event& obj)
{
    switch(obj) {
      ...
      case Cache_Event_Store:
        return "Store";
      case Cache_Event_AtomicLoad:
        return "AtomicLoad";
      case Cache_Event_AtomicStore:
        return "AtomicStore";
      ...
      case Cache_Event_ReadNoSnp:
        return "ReadNoSnp";
      case Cache_Event_ReadOnce:
        return "ReadOnce";
      case Cache_Event_CleanUnique:
        return "CleanUnique";
      case Cache_Event_MakeReadUnique:
      ...
      case Cache_Event_WriteUniqueZero:
        return "WriteUniqueZero";
      case Cache_Event_AtomicReturn:
        return "AtomicReturn";
      case Cache_Event_AtomicNoReturn:
        return "AtomicNoReturn";
      case Cache_Event_AtomicReturn_PoC:
        return "AtomicReturn_PoC";
      case Cache_Event_AtomicReturn_PoC_Alloc:
        return "AtomicReturn_PoC_Alloc";
      case Cache_Event_AtomicNoReturn_PoC:
        return "AtomicNoReturn_PoC";
      case Cache_Event_AtomicNoReturn_PoC_Alloc:
        return "AtomicNoReturn_PoC_Alloc";
      ...
      case Cache_Event_SnpStalled:
        return "SnpStalled";
      case Cache_Event_StashOnceShared:
        return "StashOnceShared";
      case Cache_Event_StashOnceUnique:
      ...
      case Cache_Event_SnpRespData_SD_Fwded_SC:
        return "SnpRespData_SD_Fwded_SC";
      ...
      case Cache_Event_SendMakeReadUnique:
        return "SendMakeReadUnique";
      ...
      case Cache_Event_SendComp_WU:
        return "SendComp_WU";
      case Cache_Event_SendDBIDResp_WUZ:
        return "SendDBIDResp_WUZ";
      case Cache_Event_SendAtomicReturn:
        return "SendAtomicReturn";
      case Cache_Event_SendAtomicNoReturn:
        return "SendAtomicNoReturn";
      case Cache_Event_SendARData:
        return "SendARData";
      case Cache_Event_SendANRData:
        return "SendANRData";
      case Cache_Event_SendDBIDResp_AR:
        return "SendDBIDResp_AR";
      case Cache_Event_SendCompData_AR:
        return "SendCompData_AR";
      case Cache_Event_SendCompDBIDResp_ANR:
        return "SendCompDBIDResp_ANR";
      case Cache_Event_SendDBIDResp_ANR:
        return "SendDBIDResp_ANR";
      case Cache_Event_SendComp_ANR:
        return "SendComp_ANR";
      ...
      case Cache_Event_SendCompUDResp:
        return "SendCompUDResp";
      ...
      case Cache_Event_FinishMakeReadUnique:
        return "FinishMakeReadUnique";
      ...
      case Cache_Event_WriteZero:
        return "WriteZero";
      case Cache_Event_Final:
        return "Final";
      case Cache_Event_null:
        return "null";
      case Cache_Event_NUM:
        return "NUM (invalid)";
      default:
        panic("Invalid value for type Cache_Event %d\n", obj);
    }
...
string_to_Cache_Event(const std::string& str)
{
    ...
    } else if (str == "AtomicReturn_PoC") {
        return Cache_Event_AtomicReturn_PoC;
    } else if (str == "AtomicReturn_PoC_Alloc") {
        return Cache_Event_AtomicReturn_PoC_Alloc;
    } else if (str == "AtomicNoReturn_PoC") {
        return Cache_Event_AtomicNoReturn_PoC;
    } else if (str == "AtomicNoReturn_PoC_Alloc") {
    ...
    } else if (str == "SnpRespData_SD_Fwded_SC") {
    ...
    } else if (str == "DelayAtomic") {
        return Cache_Event_DelayAtomic;
    ...
    } else if (str == "SendMakeReadUnique") {
        return Cache_Event_SendMakeReadUnique;
    ...
    } else if (str == "SendDBIDResp_WUZ") {
        return Cache_Event_SendDBIDResp_WUZ;
    } else if (str == "SendAtomicReturn") {
        return Cache_Event_SendAtomicReturn;
    } else if (str == "SendAtomicNoReturn") {
        return Cache_Event_SendAtomicNoReturn;
    } else if (str == "SendARData") {
        return Cache_Event_SendARData;
    } else if (str == "SendANRData") {
        return Cache_Event_SendANRData;
    } else if (str == "SendDBIDResp_AR") {
        return Cache_Event_SendDBIDResp_AR;
    } else if (str == "SendCompData_AR") {
        return Cache_Event_SendCompData_AR;
    } else if (str == "SendCompDBIDResp_ANR") {
        return Cache_Event_SendCompDBIDResp_ANR;
    } else if (str == "SendDBIDResp_ANR") {
        return Cache_Event_SendDBIDResp_ANR;
    } else if (str == "SendComp_ANR") {
        return Cache_Event_SendComp_ANR;
    ...
    } else if (str == "SendCompUDResp") {
        return Cache_Event_SendCompUDResp;
    ...
    } else if (str == "AtomicHit") {
        return Cache_Event_AtomicHit;
    ...
    } else if (str == "FinishMakeReadUnique") {
        return Cache_Event_FinishMakeReadUnique;
    ...
    } else if (str == "WriteZero") {
        return Cache_Event_WriteZero;
    } else if (str == "Final") {

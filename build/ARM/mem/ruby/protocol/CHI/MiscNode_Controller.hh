...
#ifndef __CHI_MiscNode_CONTROLLER_HH__
#define __CHI_MiscNode_CONTROLLER_HH__
...
{
  public:
    typedef CHI_MiscNode_ControllerParams Params;
...
private:
    ...
    Cycles dataLatency();
    bool inCache(const Addr& param_txnId, const bool& param_is_secure);
    bool hasBeenPrefetched(const Addr& param_txnId, const bool& param_is_secure, const RequestorID& param_requestor);
    bool hasBeenPrefetched(const Addr& param_txnId, const bool& param_is_secure);
    bool inMissQueue(const Addr& param_txnId, const bool& param_is_secure);
...
#endif // __CHI_MiscNode_CONTROLLER_H__

 ...
 *   src/mem/slicc/symbols/StateMachine.py:585
 */

// Created by slicc definition of Module "Cache coherency protocol"

#ifndef __CHI_Cache_CONTROLLER_HH__
#define __CHI_Cache_CONTROLLER_HH__
...
{
  public:
    typedef CHI_Cache_ControllerParams Params;
...
private:
    ...
    prefetch::Base* m_prefetcher_ptr;
    Cycles m_read_hit_latency;
    Cycles m_read_miss_latency;
    Cycles m_atomic_op_latency;
    ...
    Addr m_max_outstanding_transactions;
    ...
    Cycles dataLatency();
    bool fromSequencer(const CHIRequestType& param_reqType);
    void regProbePoints();
    bool inCache(const Addr& param_addr, const bool& param_is_secure);
    bool hasBeenPrefetched(const Addr& param_addr, const bool& param_is_secure, const RequestorID& param_requestor);
    bool hasBeenPrefetched(const Addr& param_addr, const bool& param_is_secure);
    bool inMissQueue(const Addr& param_addr, const bool& param_is_secure);
    bool coalesce();
    ...
    void setupPendingAtomicSend(Cache_TBE* param_tbe);
    void prepareRequest(Cache_TBE* param_tbe, const CHIRequestType& param_type, CHIRequestMsg& param_out_msg);
    void prepareRequestAtomic(Cache_TBE* param_tbe, const CHIRequestType& param_type, CHIRequestMsg& param_out_msg);
    ...
    bool isStashReqType(const CHIRequestType& param_type);
    ...
    /** \brief  */
    void Initiate_ReadNoSnp(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_ReadNoSnp_Hit(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Initiate_MakeReadUnique_Hit_InvUpstream(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Finish_MakeReadUnique(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Initiate_Atomic_UC(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_Atomic_UD(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_I(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_I(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_SD(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_SD(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_SC(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_SC(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_StoreUpgrade(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_WriteUnique_Zero(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Initiate_AtomicReturn_LocalWrite(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_WriteBack(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_LocalWrite(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_WriteBack(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_Forward(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_Forward(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_Miss_Alloc(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicReturn_Miss(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_Miss_Alloc(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Initiate_AtomicNoReturn_Miss(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Send_MakeReadUnique(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Send_AtomicReturn(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Send_AtomicNoReturn(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void ExpectNCBWrData_A(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void WriteZero(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void UpdateDataState_FromADataResp(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    void Receive_ReqResp_CopyDBID(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Send_ARData(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Send_ANRData(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void CheckARComp(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void CheckANRComp(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Send_CompUD_PD(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Send_CompData_AR(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    void Send_Comp_ANR(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Callback_AtomicHit(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void Callback_AtomicNoReturn(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    /** \brief  */
    void DelayAtomic(Cache_TBE*& m_tbe_ptr, Cache_CacheEntry*& m_cache_entry_ptr, Addr addr);
    /** \brief  */
    ...
    RubyPrefetcherProxy* m_pfProxy_ptr;
...
#endif // __CHI_Cache_CONTROLLER_H__

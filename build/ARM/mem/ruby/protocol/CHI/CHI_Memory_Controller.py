...
class CHI_Memory_Controller(RubyController):
    type = 'CHI_Memory_Controller'
    cxx_header = 'mem/ruby/protocol/CHI/Memory_Controller.hh'
    cxx_class = 'gem5::ruby::CHI::Memory_Controller'
...
if buildEnv["PROTOCOL"] == "CHI":
    class Memory_Controller(CHI_Memory_Controller):
        def __init__(self, *args, **kwargs):
            warn(
                "Memory_Controller is deprecated. Use %s_Memory_Controller instead",
                buildEnv['PROTOCOL']
            )

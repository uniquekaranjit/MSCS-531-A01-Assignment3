        ...
        if (counter == m_transitions_per_cycle) {
            ...
            try {
                            if ((((*m_datIn_ptr)).isReady((clockEdge())))) {
                                ...
                                #ifndef NDEBUG
                                if (!((! ((*in_msg_ptr)).m_usesTxnId))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:109: %s for machine %s.\n", "assert failure", name());
                                ...
                                if (!(((((((*in_msg_ptr)).m_bitMask).count()) <= m_data_channel_size) && (((((*in_msg_ptr)).m_bitMask).count()) > (0))))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:110: %s for machine %s.\n", "assert failure", name());
            ...
            try {
                            if ((((*m_snpRdy_ptr)).isReady((clockEdge())))) {
                                ...
                                if (!((((*in_msg_ptr)).m_allowRetry == (false)))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:128: %s for machine %s.\n", "assert failure", name());
                                         ...
                                         = (getDvmTBE(((*in_msg_ptr)).m_txnId));
                                            if ((tbe != NULL)) {
                                                ...
                                                if (!((*tbe).m_is_dvm_snp_tbe)) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:132: %s for machine %s.\n", "assert failure", name());
            ...
            try {
                            if ((((*m_snpIn_ptr)).isReady((clockEdge())))) {
                                #ifndef NDEBUG
                                if (!((m_is_HN == (false)))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:171: %s for machine %s.\n", "assert failure", name());
                                ...
                                #ifndef NDEBUG
                                if (!((((*in_msg_ptr)).m_allowRetry == (false)))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:174: %s for machine %s.\n", "assert failure", name());
                                         ...
                                         = (getDvmTBE(((*in_msg_ptr)).m_txnId));
                                            if ((preexistingTBE != NULL)) {
                                                ...
                                                if (!((*preexistingTBE).m_is_dvm_snp_tbe)) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:179: %s for machine %s.\n", "assert failure", name());
            ...
            try {
                            if ((((*m_retryTriggerQueue_ptr)).isReady((clockEdge())))) {
                                ...
                                if (!((((ev == Cache_Event_SendRetryAck) || (ev == Cache_Event_SendPCrdGrant)) || (ev == Cache_Event_DoRetry)))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:206: %s for machine %s.\n", "assert failure", name());
                                ...
                                ;
                                    if (((*in_msg_ptr)).m_usesTxnId) {
                                        ...
                                        #ifndef NDEBUG
                                        if (!((tbe != NULL))) {
                                            panic("Runtime Error at CHI-cache-ports.sm:210: %s for machine %s.\n", "assert failure", name());
                                        ...
                                        Cache_CacheEntry* entry
                                         = (getCacheEntry(((*in_msg_ptr)).m_addr));
                                            if ((ev == Cache_Event_DoRetry)) {
                                                #ifndef NDEBUG
                                                if (!((tbe != NULL))) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:216: %s for machine %s.\n", "assert failure", name());
                            ...
                            if ((((*m_triggerQueue_ptr)).isReady((clockEdge())))) {
                                (printResources());
                                {
                                    ...
                                    if (((*in_msg_ptr)).m_usesTxnId) {
                                        ...
                                        #ifndef NDEBUG
                                        if (!((tbe != NULL))) {
                                            panic("Runtime Error at CHI-cache-ports.sm:241: %s for machine %s.\n", "assert failure", name());
                                        ...
                                        #ifndef NDEBUG
                                        if (!((tbe != NULL))) {
                                            panic("Runtime Error at CHI-cache-ports.sm:245: %s for machine %s.\n", "assert failure", name());
                                        ...
                                        ;
                                            if ((((*in_msg_ptr)).m_from_hazard != ((*tbe).m_is_req_hazard || (*tbe).m_is_repl_hazard))) {
                                                ...
                                                if (!((((*in_msg_ptr)).m_from_hazard == (false)))) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:250: %s for machine %s.\n", "assert failure", name());
                                                ...
                                                #ifndef NDEBUG
                                                if (!(((*tbe).m_is_req_hazard || (*tbe).m_is_repl_hazard))) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:251: %s for machine %s.\n", "assert failure", name());
            ...
            try {
                            if ((((*m_reqIn_ptr)).isReady((clockEdge())))) {
                                ...
                                #ifndef NDEBUG
                                if (!((! ((*in_msg_ptr)).m_usesTxnId))) {
                                    panic("Runtime Error at CHI-cache-ports.sm:380: %s for machine %s.\n", "assert failure", name());
                                        ...
                                        Cache_TBE* tbe
                                         = (getDvmTBE(((*in_msg_ptr)).m_tlbiTransactionUid));
                                            if ((((*in_msg_ptr)).m_Type == RubyRequestType_TLBI_EXT_SYNC_COMP)) {
                                                #ifndef NDEBUG
                                                if (!((tbe != NULL))) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:406: %s for machine %s.\n", "assert failure", name());
                                                ...
                                                #ifndef NDEBUG
                                                if (!((! (tbe != NULL)))) {
                                                    panic("Runtime Error at CHI-cache-ports.sm:415: %s for machine %s.\n", "assert failure", name());

...
#ifndef __CHI_Memory_TBE_HH__
#define __CHI_Memory_TBE_HH__
		...
		m_dataBlkValid(block_size)
{
    ...
    Memory_TBE(const int& local_storSlot, const Addr& local_addr, const Addr& local_accAddr, const Addr& local_txnId, const int& local_accSize, const Memory_State& local_state, const DataBlock& local_dataBlk, const WriteMask& local_dataBlkValid, const int& local_rxtxBytes, const MachineID& local_requestor, const MachineID& local_destination, const bool& local_useDataSepResp)
    	:

...
#ifndef __CHI_CHIDataMsg_HH__
#define __CHI_CHIDataMsg_HH__
...
{
  public:
CHIDataMsg(Tick curTime, int blockSize, RubySystem* rs) : Message(curTime, blockSize, rs)
		, m_dataBlk(blockSize)
		, m_bitMask(blockSize)
{
        setRubySystem(rs);
    ...
    CHIDataMsg(const Tick curTime, const int blockSize, const RubySystem *rs, const Addr& local_addr, const CHIDataType& local_type, const MachineID& local_responder, const NetDest& local_Destination, const DataBlock& local_dataBlk, const WriteMask& local_bitMask, const bool& local_usesTxnId, const Addr& local_txnId, const MessageSizeType& local_MessageSize)
    ...
    void initBlockSize(int block_size)
    {
    	...
    	m_bitMask.setBlockSize(block_size);
    }

...
#ifndef __CHI_Cache_TBE_HH__
#define __CHI_Cache_TBE_HH__
...
{
  public:
Cache_TBE(int block_size)
	:
		m_atomic_op(block_size)
	, 
		m_dataBlk(block_size)
	, 
		m_oldDataBlk(block_size)
	, 
		m_dataBlkValid(block_size)
	, 
		m_snd_pendBytes(block_size)
{
        ...
        m_txnId = -1; // default for this field
        m_ns = true; // default for this field
        ...
        m_is_remote_pf = false;
         // default value of bool
        // m_atomic_op has no default
        m_atomic_to_be_done = false;
         // default value of bool
        m_atomic_to_be_wb = false;
         // default value of bool
        ...
        // m_oldDataBlk has no default
        // m_dataBlkValid has no default
        m_dataValid = false;
         // default value of bool
        m_dataAMOValid = false;
         // default value of bool
        m_dataDirty = false;
         // default value of bool
    ...
    {
    	block_size_bits = floorLog2(block_size);
    	m_atomic_op.setBlockSize(block_size);
    	m_dataBlk.setBlockSize(block_size);
    	m_oldDataBlk.setBlockSize(block_size);
    	m_dataBlkValid.setBlockSize(block_size);
    	m_snd_pendBytes.setBlockSize(block_size);
    }
    void setRubySystem(RubySystem *ruby_system)
    {
    // m_dir_sharers requires RubySystem
    	m_dir_sharers.setRubySystem(ruby_system);
    // m_pendReqDest requires RubySystem
    	m_pendReqDest.setRubySystem(ruby_system);
    }
    ...
    /** \brief Const accessor method for ns field.
     *  \return ns field
     */
    const bool&
    getns() const
    ...
    /** \brief Const accessor method for atomic_op field.
     *  \return atomic_op field
     */
    const WriteMask&
    getatomic_op() const
    {
    ...
    /** \brief Const accessor method for atomic_to_be_done field.
     *  \return atomic_to_be_done field
     */
    const bool&
    getatomic_to_be_done() const
    {
        return m_atomic_to_be_done;
    }
    /** \brief Const accessor method for atomic_to_be_wb field.
     *  \return atomic_to_be_wb field
     */
    const bool&
    getatomic_to_be_wb() const
    {
        return m_atomic_to_be_wb;
    }
    ...
    /** \brief Const accessor method for oldDataBlk field.
     *  \return oldDataBlk field
     */
    const DataBlock&
    getoldDataBlk() const
    {
    ...
    /** \brief Const accessor method for dataAMOValid field.
     *  \return dataAMOValid field
     */
    const bool&
    getdataAMOValid() const
    {
        return m_dataAMOValid;
    }
    ...
    /** \brief Non-const accessor method for ns field.
     *  \return ns field
     */
    bool&
    getns()
    ...
    /** \brief Non-const accessor method for atomic_op field.
     *  \return atomic_op field
     */
    WriteMask&
    getatomic_op()
    ...
    /** \brief Non-const accessor method for atomic_to_be_done field.
     *  \return atomic_to_be_done field
     */
    bool&
    getatomic_to_be_done()
    {
        return m_atomic_to_be_done;
    }
    /** \brief Non-const accessor method for atomic_to_be_wb field.
     *  \return atomic_to_be_wb field
     */
    bool&
    getatomic_to_be_wb()
    ...
    /** \brief Non-const accessor method for oldDataBlk field.
     *  \return oldDataBlk field
     */
    DataBlock&
    getoldDataBlk()
    ...
    /** \brief Non-const accessor method for dataAMOValid field.
     *  \return dataAMOValid field
     */
    bool&
    getdataAMOValid()
    ...
    /** \brief Mutator method for ns field */
    void
    setns(const bool& local_ns)
    {
        m_ns = local_ns;
    }
    ...
    /** \brief Mutator method for atomic_op field */
    void
    setatomic_op(const WriteMask& local_atomic_op)
    {
        m_atomic_op = local_atomic_op;
    }
    /** \brief Mutator method for atomic_to_be_done field */
    void
    setatomic_to_be_done(const bool& local_atomic_to_be_done)
    {
        m_atomic_to_be_done = local_atomic_to_be_done;
    }
    /** \brief Mutator method for atomic_to_be_wb field */
    void
    setatomic_to_be_wb(const bool& local_atomic_to_be_wb)
    {
        m_atomic_to_be_wb = local_atomic_to_be_wb;
    }
    ...
    /** \brief Mutator method for oldDataBlk field */
    void
    setoldDataBlk(const DataBlock& local_oldDataBlk)
    {
        m_oldDataBlk = local_oldDataBlk;
    }
    ...
    /** \brief Mutator method for dataAMOValid field */
    void
    setdataAMOValid(const bool& local_dataAMOValid)
    {
        m_dataAMOValid = local_dataAMOValid;
    }
  ...
  //private:
    ...
    /** Transaction ID. We default to -1 for debug purposes */
    Addr m_txnId;
    /** Secure State of the transaction. NS=NonSecure */
    bool m_ns;
    /** Requestor ID */
    ...
    WriteMask m_atomic_op;
    /** We have yet to perform the atomic */
    bool m_atomic_to_be_done;
    /** We are writebacking the atomic */
    bool m_atomic_to_be_wb;
    ...
    DataBlock m_dataBlk;
    /** Local copy of the line before executing atomic */
    DataBlock m_oldDataBlk;
    /** Marks which bytes in the DataBlock are valid */
    WriteMask m_dataBlkValid;
    /** Local copy is valid */
    bool m_dataValid;
    /** Local copy is valid for AMO */
    bool m_dataAMOValid;

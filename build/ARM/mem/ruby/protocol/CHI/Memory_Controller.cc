    ...
    : AbstractController(p)
{
    ...
    p.ruby_system->m_num_controllers[MachineType_Memory]++;
...
Memory_Controller::regStats()
{
    ...
    if (m_version == 0) {
        ...
        for (Memory_Event event = Memory_Event_FIRST;
            ...
            int num_controllers =
                m_ruby_system->m_num_controllers[MachineType_Memory];
    ...
    const std::vector<Memory_Event> out_trans_evs = {};
    const std::vector<Memory_Event> in_trans_evs = {};
    const std::unordered_map<Memory_Event, std::vector<Memory_State>>
                                in_trans_evs_states = {};
    ...
    for (const auto event : in_trans_evs) {
        std::string stat_name =
            "inTransLatHist." + Memory_Event_to_string(event);
        statistics::Histogram* t =
            new statistics::Histogram(&stats, stat_name.c_str());
        ...
        for (const auto initial_state : in_trans_evs_states.at(event)) {
            ...
            for (Memory_State final_state = Memory_State_FIRST;
                ...
                std::string stat_name = "inTransLatHist." +
                    ...
                    Memory_State_to_string(final_state) + ".total";
                statistics::Scalar* t =
...
Memory_Controller::checkAllocateTBE(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    DPRINTF(RubyGenerated, "executing checkAllocateTBE\n");
        ...
        if (!(((*in_msg_ptr)).m_allowRetry)) {
            panic("Runtime Error at CHI-mem.sm:462: %s for machine %s.\n", "assert failure", name());

        }
        #endif
        ;
        {
            std::shared_ptr<Memory_TriggerMsg> out_msg = std::make_shared<Memory_TriggerMsg>(clockEdge(),     m_ruby_system->getBlockSizeBytes(), m_ruby_system);
            ...
            ((*m_triggerQueue_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles((0))), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
        }
        }
    }
...
if (!((((*in_msg_ptr)).m_allowRetry == (false)))) {
    panic("Runtime Error at CHI-mem.sm:477: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((((*m_storTBEs_ptr)).areNSlotsAvailable((1))))) {
    panic("Runtime Error at CHI-mem.sm:488: %s for machine %s.\n", "assert failure", name());
...
(*m_tbe_ptr).m_requestor = ((*in_msg_ptr)).m_requestor;
    ...
    (*m_tbe_ptr).m_txnId = ((*in_msg_ptr)).m_txnId;
    }
...
if (!(((*m_pendingWrites_ptr) >= (1)))) {
    panic("Runtime Error at CHI-mem.sm:513: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::deallocateTBE(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:518: %s for machine %s.\n", "assert failure", name());
...
unset_tbe(m_tbe_ptr);;
    if (((((*m_retryQueue_ptr)).empty()) == (false))) {
        #ifndef NDEBUG
        if (!((((*m_storTBEs_ptr)).areNSlotsAvailable((1))))) {
            panic("Runtime Error at CHI-mem.sm:524: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::sendReadReceipt(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:537: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::sendCompDBIDResp(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:549: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::triggerSendMemoryRead(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:559: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::sendMemoryRead(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:567: %s for machine %s.\n", "assert failure", name());
...
;
{
    ...
    (*out_msg).m_Len = (0);
    ((*m_requestToMemory_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_memory_controller_latency)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
}
...
Memory_Controller::sendMemoryWrite(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:578: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::prepareSend(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:592: %s for machine %s.\n", "assert failure", name());
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:602: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::sendDataAndCheck(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:610: %s for machine %s.\n", "assert failure", name());
...
if (!(((*m_tbe_ptr).m_rxtxBytes < (*m_blockSize_ptr)))) {
    panic("Runtime Error at CHI-mem.sm:611: %s for machine %s.\n", "assert failure", name());
    ...
    Cycles delay
     = (intToCycles((0)));
        ...
        }
        {
            ...
            ((*m_triggerQueue_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(delay)), m_ruby_system->getRandomization(), m_ruby_system->getWarmupEnabled());
        }
...
Memory_Controller::checkForReceiveCompletion(Memory_TBE*& m_tbe_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at CHI-mem.sm:644: %s for machine %s.\n", "assert failure", name());

}
#endif
;
DPRINTF(RubySlicc, "CHI-mem.sm:645: rxtxBytes=%d\n", (*m_tbe_ptr).m_rxtxBytes);
#ifndef NDEBUG
if (!((((*m_tbe_ptr).m_rxtxBytes <= (*m_tbe_ptr).m_accSize) && ((*m_tbe_ptr).m_rxtxBytes > (0))))) {
    panic("Runtime Error at CHI-mem.sm:646: %s for machine %s.\n", "assert failure", name());
...
;
    if (((*m_tbe_ptr).m_rxtxBytes == (*m_tbe_ptr).m_accSize)) {
        ...
        if (!((((*m_tbe_ptr).m_dataBlkValid).getMask((addressOffset((*m_tbe_ptr).m_accAddr, (*m_tbe_ptr).m_addr)), (*m_tbe_ptr).m_accSize)))) {
            panic("Runtime Error at CHI-mem.sm:653: %s for machine %s.\n", "assert failure", name());
                    ...
                    if ((param_type == CHIRequestType_ReadNoSnp)) {
                        return Memory_Event_ReadNoSnp;
                            ...
                            if ((param_type == CHIRequestType_ReadNoSnpSep)) {
                                ...
                                panic("Runtime Error at CHI-mem.sm:138: %s for machine %s.\n", ("Invalid CHIRequestType"), name());
                                ;
                            }
                        }
                    }
...
{
panic("Runtime Error at CHI-mem.sm:143: %s for machine %s.\n", ("Invalid CHIResponseType"), name());
;
...
Memory_Controller::dataToEvent(const CHIDataType& param_type)
{
    if ((param_type == CHIDataType_NCBWrData)) {
        ...
        panic("Runtime Error at CHI-mem.sm:150: %s for machine %s.\n", ("Invalid CHIDataType"), name());
        ;
    }
...
Memory_Controller::getState(Memory_TBE* param_tbe, const Addr& param_addr)
{
    if ((param_tbe != NULL)) {
        ...
        if (!(((*param_tbe).m_addr == param_addr))) {
            panic("Runtime Error at CHI-mem.sm:247: %s for machine %s.\n", "assert failure", name());
...
Memory_Controller::setState(Memory_TBE* param_tbe, const Addr& param_addr, const Memory_State& param_state)
{
    if ((param_tbe != NULL)) {
        #ifndef NDEBUG
        if (!(((*param_tbe).m_addr == param_addr))) {
            panic("Runtime Error at CHI-mem.sm:256: %s for machine %s.\n", "assert failure", name());
...
{
    if ((respondsTo(param_addr))) {
        DPRINTF(RubySlicc, "CHI-mem.sm:282: functionalRead %x\n", param_addr);
        Memory_TBE* tbe
         = (((*m_TBEs_ptr)).lookup(param_addr));
            if (((param_mask).isEmpty())) {
                (functionalMemoryRead(param_pkt));
                ((param_mask).fillMask());
                DPRINTF(RubySlicc, "CHI-mem.sm:288: functionalRead mem %x %s\n", param_addr, param_mask);
            }
                if ((tbe != NULL)) {
                    WriteMask read_mask;
                    ...
                    ((read_mask).andMask((*tbe).m_dataBlkValid));
                        if ((((read_mask).isEmpty()) == (false))) {
                            ...
                            DPRINTF(RubySlicc, "CHI-mem.sm:300: functionalRead tbe %x %s %s %s\n", param_addr, (*tbe).m_dataBlk, read_mask, param_mask);
        ...
        Memory_TBE* tbe
         = (((*m_TBEs_ptr)).lookup(param_addr));
            if ((tbe != NULL)) {
                ...
                DPRINTF(RubySlicc, "CHI-mem.sm:314: functionalWrite tbe %x %s\n", param_addr, (*tbe).m_dataBlk);
            }
            num_functional_writes = (num_functional_writes + (functionalMemoryWrite(param_pkt)));
            DPRINTF(RubySlicc, "CHI-mem.sm:317: functionalWrite mem %x\n", param_addr);

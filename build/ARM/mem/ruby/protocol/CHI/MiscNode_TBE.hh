...
#ifndef __CHI_MiscNode_TBE_HH__
#define __CHI_MiscNode_TBE_HH__
...
MiscNode_TBE(int block_size)
{
    ...
    {
    // m_notSentTargets requires RubySystem
    	m_notSentTargets.setRubySystem(ruby_system);
    // m_pendingTargets requires RubySystem
    	m_pendingTargets.setRubySystem(ruby_system);
    // m_receivedTargets requires RubySystem
    	m_receivedTargets.setRubySystem(ruby_system);
    }

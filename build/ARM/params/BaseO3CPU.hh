    ...
    : public BaseCPUParams
{
    ...
    unsigned SQEntries;
    unsigned SSITAssoc;
    gem5::IndexingPolicyTemplate<gem5::AddrTypes> * SSITIndexingPolicy;
    gem5::replacement_policy::Base * SSITReplPolicy;
    uint64_t SSITSize;
    unsigned activity;
    ...
    unsigned numRobs;
    unsigned recvRespBufferSize;
    unsigned recvRespMaxCachelines;
    bool recvRespThrottling;

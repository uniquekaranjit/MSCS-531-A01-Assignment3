...
#ifndef __PARAMS__CHI_Cache_Controller__
#define __PARAMS__CHI_Cache_Controller__
...
namespace gem5
{
struct CHI_Cache_ControllerParams
    : public RubyControllerParams
{
    ...
    bool allow_SD;
    Cycles atomic_op_latency;
    gem5::ruby::CacheMemory * cache;
    bool comp_anr;
    Cycles comp_anr_latency;
    bool comp_wu;
    ...
    Addr max_outstanding_transactions;
...
#endif // __PARAMS__CHI_Cache_Controller__

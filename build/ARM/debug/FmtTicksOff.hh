...
{
    ~FmtTicksOff() {}
    SimpleFlag flagFmtTicksOff;

    FmtTicksOff() : flagFmtTicksOff("FmtTicksOff", "Don't show tick count on debug messages", true) {}

} instanceFmtTicksOff;
} // namespace unions

inline constexpr const auto& FmtTicksOff =
    ::gem5::debug::unions::instanceFmtTicksOff.flagFmtTicksOff;
